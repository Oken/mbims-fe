                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12">
                        <div className="mb-3">
                          ...
                          <Select classNamePrefix="react-select" options={leaves} placeholder="Sick Leave" />
                        </div>
                      </div>
                      <div className="col-lg-12">
                          ...
                          <div className="leave-apply">
                            ...
                            <div className="leave-time">
                              <div className="input-blocks mb-0">
                                <Select classNamePrefix="react-select" options={leavetype1} placeholder="Full Day" />
                              </div>
                            </div>
                          </div>
                          <div className="leave-apply">
                            ...
                            <div className="leave-time">
                              <div className="input-blocks mb-0">
                                <Select classNamePrefix="react-select" options={leavetype} placeholder="Full Day" />
                              </div>
                            </div>
                          </div>
                        </div>

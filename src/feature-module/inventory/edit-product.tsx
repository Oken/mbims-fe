            ...
            <li>
              <OverlayTrigger placement="top" overlay={renderCollapseTooltip}>
                ...
                >
                  ...
                  <FeatherIcon icon="chevron-up" className="feather-chevron-up" />
                </Link>
              </OverlayTrigger>
            </li>
          </ul>
                    ...
                    >
                      <div className="addproduct-icon">
                        <h5>
                          ...
                          <FeatherIcon icon="info" className="add-info" />

                          <span>Product Information</span>
                        </h5>
                        <Link to="#">
                          <ChevronDown className="chevron-down-add" />
                          <FeatherIcon icon="chevron-down" className="chevron-down-add" />
                        </Link>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="accordion-body">
                      <div className="row">
                        ...
                        <div className="col-lg-4 col-sm-6 col-12">
                          <div className="mb-3 add-product">
                            ...
                            <Select classNamePrefix="react-select" options={warehouse} placeholder="Legendary" />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-lg-4 col-sm-6 col-12">
                          <div className="input-blocks add-product list">
                            <label>SKU</label>
                            <input type="text" className="form-control list" placeholder="Enter SKU" />
                            <Link to={route.addproduct} className="btn btn-primaryadd">
                              Generate Code
                            </Link>
                          </div>
                        </div>
                            ...
                            <div className="mb-3 add-product">
                              <div className="add-newplus">
                                ...
                                <Link to="#" data-bs-toggle="modal" data-bs-target="#add-units-category">
                                  ...
                                  <FeatherIcon icon="plus-circle" className="plus-down-add" />
                                  <span>Add New</span>
                                </Link>
                              </div>
                              <Select classNamePrefix="react-select" options={category} placeholder="Lenovo" />
                            </div>
                          </div>
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="mb-3 add-product">
                              <label className="form-label">Sub Category</label>
                              <Select classNamePrefix="react-select" options={subcategory} placeholder="Lenovo" />
                            </div>
                          </div>
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="mb-3 add-product">
                          ...
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="mb-3 add-product">
                              <div className="add-newplus">
                                ...
                                <Link to="#" data-bs-toggle="modal" data-bs-target="#add-units-brand">
                                  <PlusCircle className="plus-down-add" />
                                  <FeatherIcon icon="plus-circle" className="plus-down-add" />
                                  <span>Add New</span>
                                </Link>
                              </div>
                              <Select classNamePrefix="react-select" options={brand} placeholder="Nike" />
                            </div>
                          </div>
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="mb-3 add-product">
                              <div className="add-newplus">
                                ...
                                <Link to="#" data-bs-toggle="modal" data-bs-target="#add-unit">
                                  <PlusCircle className="plus-down-add" />
                                  <FeatherIcon icon="plus-circle" className="plus-down-add" />
                                  <span>Add New</span>
                                </Link>
                              </div>
                              <Select classNamePrefix="react-select" options={unit} placeholder="Kg" />
                            </div>
                          </div>
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="mb-3 add-product">
                      ...
                      <div className="row">
                        <div className="col-lg-6 col-sm-6 col-12">
                          <div className="mb-3 add-product">
                            ...
                            <Select classNamePrefix="react-select" options={barcodesymbol} placeholder="Code34" />
                          </div>
                        </div>
                        <div className="col-lg-6 col-sm-6 col-12">
                          <div className="input-blocks add-product list">
                            <label>Item Code</label>
                            <input type="text" className="form-control list" placeholder="Please Enter Item Code" />
                            <Link to={route.addproduct} className="btn btn-primaryadd">
                              Generate Code
                            </Link>
                          </div>
                      ...
                      <div className="col-lg-12">
                        <div className="input-blocks summer-description-box transfer mb-3">
                          ...
                          <textarea className="form-control h-100" rows={5} defaultValue={''} />
                      ...
                      <div className="text-editor add-list">
                        <div className="addproduct-icon list icon">
                          <h5>
                            ...
                            <FeatherIcon icon="life-buoy" className="add-info" />
                    ...
                    <div className="accordion-body">
                      ...
                      <div className="tab-content" id="pills-tabContent">
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-4 col-sm-6 col-12">
                              <div className="input-blocks add-product">
                                ...
                                <Select classNamePrefix="react-select" options={taxtype} placeholder="Select Option" />
                              </div>
                            </div>
                          </div>
                          <div className="row">
                                      ...
                                      <div className="add-choosen">
                                        <div className="input-blocks">
                                          <div className="image-upload">
                                            ...
                                            <div className="image-uploads">
                                              ...
                                              <FeatherIcon icon="plus-circle" className="plus-down-add me-0" />
                                              <h4>Add Images</h4>
                                            </div>
                                          </div>
                                        </div>
                                        {isImageVisible1 && (
                                          <div className="phone-img">
                                            <ImageWithBasePath src="assets/img/products/phone-add-2.png" alt="image" />
                                            <Link to="#">
                                              <X
                                                className="x-square-add remove-product"
                                                onClick={handleRemoveProduct1}
                                              />
                                              <span onClick={handleRemoveProduct1}>
                                                <FeatherIcon icon="x" className="x-square-add remove-product" />
                                              </span>
                                            </Link>
                                          </div>
                                        )}
                                        {isImageVisible && (
                                          <div className="phone-img">
                                            <ImageWithBasePath src="assets/img/products/phone-add-1.png" alt="image" />
                                            <Link to="#">
                        ...
                        >
                              ...
                              <div className="input-blocks add-product">
                                ...
                                <div className="row">
                                  <div className="col-lg-10 col-sm-10 col-10">
                                    <select className="form-control variant-select select-option" id="colorSelect">
                                  ...
                                  <div className="col-lg-2 col-sm-2 col-2 ps-0">
                                    <div className="add-icon tab">
                                      ...
                                      >
                                        ...
                                        <FeatherIcon icon="plus-circle" className="feather feather-plus-circle" />
                                      </Link>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div className="modal-body-table variant-table" id="variant-table">
                                  ...
                                  <tr>
                                    ...
                                    <td className="action-table-data">
                                      <div className="edit-delete-action">
                                        ...
                                        >
                                          <i data-feather="plus" className="feather-edit" />
                                        </Link>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div className="product-quantity">
                                        ...
                                        <input type="text" className="quntity-input" defaultValue={3} />
                                        <span className="quantity-btn">
                                          +
                                          <i data-feather="plus-circle" className="plus-circle" />
                                        </span>
                      ...
                      <div className="text-editor add-list">
                        <div className="addproduct-icon list">
                          <h5>
                            ...
                            <FeatherIcon icon="list" className="add-info" />
                      ...
                      <div className="text-editor add-list add">
                        ...
                        <div className="row">
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="input-blocks add-product">
                              <label>Discount Type</label>
                              <Select classNamePrefix="react-select" options={discounttype1} placeholder="Choose" />
                            </div>
                          </div>
                        </div>
                        <div className="row">

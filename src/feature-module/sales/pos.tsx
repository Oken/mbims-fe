      ...
      <div className="page-wrapper pos-pg-wrapper ms-0">
        <div className="content pos-design p-0">
          <div className="btn-row d-sm-flex align-items-center">
            <Link to="#" className="btn btn-secondary mb-xs-3" data-bs-toggle="modal" data-bs-target="#orders">
              <span className="me-1 d-flex align-items-center">
                {/* <ShoppingCart className="feather-16" /> */}
                <FeatherIcon icon="shopping-cart" className="feather-16" />
              </span>
              View Orders
            </Link>
            <Link to="#" className="btn btn-info">
              <span className="me-1 d-flex align-items-center">
                ...
                <FeatherIcon icon="rotate-ccw" className="feather-16" />
              </span>
              Reset
            </Link>
            <Link to="#" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#recents">
              <span className="me-1 d-flex align-items-center">
                {/* <RefreshCcw className="feather-16" /> */}
                <FeatherIcon icon="refresh-ccw" className="feather-14" />
              </span>
              Transaction
            </Link>
          </div>
                    ...
                    <div className="tab_content active" data-tab="all">
                      <div className="row">
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-01.png" alt="Products" />
                              <span>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-02.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-03.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-04.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-05.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-06.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-07.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-08.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-09.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-10.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-11.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-18.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                    ...
                    <div className="tab_content" data-tab="mobiles">
                      <div className="row">
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-14.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                    ...
                    <div className="tab_content" data-tab="laptops">
                      <div className="row">
                        ...
                        <div className="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                          <div className="product-info default-cover card">
                            <Link to="#" className="img-bg">
                              <ImageWithBasePath src="assets/img/products/pos-product-13.png" alt="Products" />
                              <span>
                                <Check className="feather-16" />
                              </span>
                            </Link>
                ...
                <div className="customer-info block-section">
                  ...
                  <div className="input-block d-flex align-items-center">
                    <div className="flex-grow-1">
                      <Select options={customers} classNamePrefix="react-select" placeholder="Select an option" />
                    </div>
                    <Link to="#" className="btn btn-primary btn-icon" data-bs-toggle="modal" data-bs-target="#create">
                      <UserPlus className="feather-16" />
                    </Link>
                  </div>
                  <div className="input-block">
                    <Select options={products} classNamePrefix="react-select" placeholder="Select an option" />
                  </div>
                </div>
                <div className="product-added block-section">
                  ...
                  <div className="product-wrap">
                    <div className="product-list d-flex align-items-center justify-content-between">
                      ...
                      >
                        <Link to="#" className="img-bg">
                          <ImageWithBasePath src="assets/img/products/pos-product-16.png" alt="Products" />
                        </Link>
                        <div className="info">
                          <span>PT0005</span>
                          <h6>
                      ...
                      <div className="qty-item text-center">
                        <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-minus">Minus</Tooltip>}>
                          ...
                          >
                            ...
                            <FeatherIcon icon="minus-circle" className="feather-14" />
                          </Link>
                        </OverlayTrigger>

                        <input type="text" className="form-control text-center" name="qty" value={quantity} readOnly />
                        <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-plus">Plus</Tooltip>}>
                          ...
                          >
                            ...
                            <FeatherIcon icon="plus-circle" className="feather-14" />
                          </Link>
                        </OverlayTrigger>
                      </div>
                      <div className="d-flex align-items-center action">
                        ...
                        <Link onClick={showConfirmationAlert} className="btn-icon delete-icon confirm-text" to="#">
                    ...
                    <div className="product-list d-flex align-items-center justify-content-between">
                      ...
                      >
                        <Link to="#" className="img-bg">
                          <ImageWithBasePath src="assets/img/products/pos-product-17.png" alt="Products" />
                        </Link>
                        <div className="info">
                          <span>PT0235</span>
                          <h6>
                      ...
                      <div className="qty-item text-center">
                        ...
                        <input type="text" className="form-control text-center" name="qty" value={quantity1} readOnly />
                    ...
                    <div className="product-list d-flex align-items-center justify-content-between">
                      ...
                      <div className="qty-item text-center">
                        ...
                        <input type="text" className="form-control text-center" name="qty" value={quantity2} readOnly />
                    ...
                    <div className="product-list d-flex align-items-center justify-content-between">
                      ...
                      <div className="qty-item text-center">
                        ...
                        <input type="text" className="form-control text-center" name="qty" value={quantity3} readOnly />
                    ...
                    <div className="row">
                      <div className="col-12 col-sm-4">
                        <div className="input-block">
                          ...
                          <Select classNamePrefix="react-select" options={gst} placeholder="GST 5%" />
                        </div>
                      </div>
                      <div className="col-12 col-sm-4">
                        <div className="input-block">
                          <label>Shipping</label>
                          <Select classNamePrefix="react-select" options={shipping} placeholder="15" />
                        </div>
                      </div>
                      <div className="col-12 col-sm-4">
                        <div className="input-block">
                          <label>Discount</label>
                          <Select classNamePrefix="react-select" options={discount} placeholder="10%" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row d-flex align-items-center justify-content-center methods">
                    <div className="col-md-6 col-lg-4 item">
                      <div className="default-cover">
                        <Link to="#">
                          <ImageWithBasePath src="assets/img/icons/cash-pay.svg" alt="Payment Method" />
                          <span>Cash</span>
                        </Link>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-4 item">
                      <div className="default-cover">
                        <Link to="#">
                          <ImageWithBasePath src="assets/img/icons/credit-card.svg" alt="Payment Method" />
                    ...
                    <div className="col-md-6 col-lg-4 item">
                      <div className="default-cover">
                        <Link to="#">
                          <ImageWithBasePath src="assets/img/icons/qr-scan.svg" alt="Payment Method" />
                          <span>Scan</span>
                        </Link>
                      </div>
                    </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="d-flex justify-content-end">
              <button type="button" className="close p-0" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div className="modal-body">
              <div className="icon-head text-center">
                <Link to="#">
                  <ImageWithBasePath src="assets/img/logo.png" width={100} height={30} alt="Receipt Logo" />
                </Link>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="input-blocks add-product">
                      ...
                      <Select classNamePrefix="react-select" options={tax} placeholder="Select Option" />
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="input-blocks add-product">
                  ...
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="input-blocks add-product">
                      ...
                      <Select classNamePrefix="react-select" options={discounttype} placeholder="Select Option" />
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="input-blocks add-product">
                  ...
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="input-blocks add-product">
                      ...
                      <Select classNamePrefix="react-select" options={units} placeholder="Select Option" />
                    </div>
                  </div>
                </div>
                <div className="modal-footer d-sm-flex justify-content-end">
                          ...
                          <tr>
                            ...
                            <td className="action-table-data">
                              <div className="edit-delete-action">
                                ...
                                <Link onClick={showConfirmationAlert} className="p-2 confirm-text" to="#">
              ...
              <div className="tabs-sets">
                ...
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="onhold" role="tabpanel" aria-labelledby="onhold-tab">
                    ...
                    <div className="order-body">
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-secondary d-inline-block mb-4">Order ID : #666659</span>
                        <div className="row">
                        ...
                        <p className="p-4">Customer need to recheck the product once</p>
                        <div className="btn-row d-sm-flex align-items-center justify-content-between">
                          <Link to="#" className="btn btn-info btn-icon flex-fill">
                            Open
                          </Link>
                          <Link to="#" className="btn btn-danger btn-icon flex-fill">
                            Products
                          </Link>
                          <Link to="#" className="btn btn-success btn-icon flex-fill">
                            Print
                          </Link>
                        </div>
                      </div>
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-secondary d-inline-block mb-4">Order ID : #666660</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                      ...
                      <div className="default-cover p-4">
                        <span className="badge bg-secondary d-inline-block mb-4">Order ID : #666661</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                        ...
                        <p className="p-4 mb-4">Customer need to recheck the product once</p>
                        <div className="btn-row d-flex align-items-center justify-content-between">
                          <Link to="#" className="btn btn-info btn-icon flex-fill">
                            Open
                          </Link>
                  ...
                  <div className="tab-pane fade" id="unpaid" role="tabpanel">
                    ...
                    <div className="order-body">
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-info d-inline-block mb-4">Order ID : #666662</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                      ...
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-info d-inline-block mb-4">Order ID : #666663</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                      ...
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-info d-inline-block mb-4">Order ID : #666664</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                  ...
                  <div className="tab-pane fade" id="paid" role="tabpanel">
                    ...
                    <div className="order-body">
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-primary d-inline-block mb-4">Order ID : #666665</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                      ...
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-primary d-inline-block mb-4">Order ID : #666666</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>
                      ...
                      <div className="default-cover p-4 mb-4">
                        <span className="badge bg-primary d-inline-block mb-4">Order ID : #666667</span>
                        <div className="row">
                          <div className="col-sm-12 col-md-6 record mb-3">
                            <table>
                              <tbody>

...
import EditPurchaseReturns from '../../core/modals/purchases/edit-purchase-returns';
import Swal from 'sweetalert2';
import withReactContent from 'sweetalert2-react-content';
import Table from '../../core/pagination/data-table';
import { purchasesreturn } from '../../core/json/purchasereturn';
import AddPurchaseReturn from '../../core/modals/purchases/add-purchase-return';
...
const PurchaseReturns = () => {
  ...
  const filteredData: any = purchasereturndata.filter((entry) => {
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <FeatherIcon icon="calender" className="info-info" />
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <FeatherIcon icon="stop-circle" className="info-info" />
                        <Select
                          className="img-select"
                          options={supplier}
                          classNamePrefix="react-select"

                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="mb-3">
                          ...
                          <Select options={fields} classNamePrefix="react-select" placeholder="Choose an option" />
                        </div>
                      </div>
                      <div className="col-lg-12">
                        <div className="mb-3">
                      ...
                      <div className="col-lg-12">
                        <div className="mb-3">
                          ...
                          <Select options={textarea} classNamePrefix="react-select" placeholder="Choose an option" />
                        </div>
                      </div>
                      <div className="col-lg-12">

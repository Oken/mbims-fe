                  ...
                  <div className="top-online-contacts">
                    ...
                    <div className="swiper-container">
                      <div className="swiper-wrapper d-flex">
                        ...
                        <div className="top-contacts-box  me-1">
                          <div className="profile-img online">
                            <ImageWithBasePath src="assets/img/avatar/avatar-1.jpg" alt="" />
                          </div>
                        </div>
                        <div className="top-contacts-box me-1">
                          <div className="profile-img online">
                            <ImageWithBasePath src="assets/img/avatar/avatar-7.jpg" alt="" />
                          </div>
                        </div>
                        <div className="top-contacts-box me-1">
                          <div className="profile-img online">
                            <ImageWithBasePath src="assets/img/avatar/avatar-5.jpg" alt="" />
                          </div>
                        </div>
                        <div className="top-contacts-box me-1">
                          <div className="profile-img online">
                            <ImageWithBasePath src="assets/img/avatar/avatar-3.jpg" alt="" />
                          </div>
                        </div>
                        <div className="top-contacts-box me-1">
                          <div className="profile-img online">
            ...
            <div className="slimscroll">
              <Scrollbars>
                <div className="chat-header">
                    ...
                    <div className="d-lg-none">
                      <ul className="list-inline mt-2 me-2">
                        <li className="list-inline-item">
                          <Link className="text-muted px-0 left_sides" to="#" data-chat="open">
                  ...
                  <div className="chat-options ">
                    <ul className="list-inline">
                      ...
                      <li className="list-inline-item">
                        <OverlayTrigger
                          placement="bottom"
                          overlay={<Tooltip id={`tooltip-${route.videocall}`}>Video Call</Tooltip>}
                        >
                          <Link to={route.videocall} className="btn btn-outline-light">
                      ...
                      <li className="list-inline-item">
                        <OverlayTrigger
                          placement="bottom"
                          overlay={<Tooltip id={`tooltip-${route.audiocall}`}>Voice Call</Tooltip>}
                        >
                          <Link to={route.audiocall} className="btn btn-outline-light">
                            <i className="bx bx-phone" />
                          </Link>
                        </OverlayTrigger>
                      </li>
                      <li className="list-inline-item dream_profile_menu">
                        <Link to="#" className="btn btn-outline-light not-chat-user" onClick={handleAddVisible}>
                  ...
                  {/* Chat Search */}
                  <div className={isShow ? 'chat-search visible-chat' : 'chat-search'}>
                    <form>
                      <span className="form-control-feedback" onClick={handleShowClass}>
                        <i className="bx bx-search" />
                      </span>
                      <input type="text" name="chat-search" placeholder="Search Chats" className="form-control" />
                      <div className="close-btn-chat">
                        <span className="material-icons" onClick={handleShowremoveClass}>
                          close
                        </span>
                      </div>
                    </form>
                  ...
                  <div className="messages">
                              ...
                              <li className="emoj-action">
                                ...
                                <div className="emoj-group-list">
                                  <ul>
                                    <li>
                                      <Link to="#">
                                        <ImageWithBasePath src="assets/img/icons/emoj-icon-01.svg" alt="Icon" />
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                        <ImageWithBasePath src="assets/img/icons/emoj-icon-02.svg" alt="Icon" />
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                        <ImageWithBasePath src="assets/img/icons/emoj-icon-03.svg" alt="Icon" />
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                        <ImageWithBasePath src="assets/img/icons/emoj-icon-04.svg" alt="Icon" />
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                        <ImageWithBasePath src="assets/img/icons/emoj-icon-05.svg" alt="Icon" />
                                      </Link>
                                    </li>
                          ...
                          <div className="chat-voice-group">
                            <ul>
                              <li>
                                <Link to="#">
                                  <span>
                                    <ImageWithBasePath src="assets/img/icons/play-01.svg" alt="image" />
                                  </span>
                                </Link>
                              </li>
                              <li>
                                <ImageWithBasePath src="assets/img/icons/voice.svg" alt="image" />
                              </li>
                              <li>0:05</li>
                            </ul>
                          </div>
                    ...
                    <div className="chats">
                      ...
                      <div className="chat-content">
                        ...
                        <div className="message-content award-link chat-award-link">
                          ...
                          <ImageWithBasePath src="assets/img/sending-img.png" alt="img" />
                          <div className="emoj-group">
                            <ul>
                              <li className="emoj-action">
                                <Link to="#">
                        ...
                        <div className="message-content review-files">
                          <p className="d-flex align-items-center">
                            ...
                            <span className="ms-1 d-flex">
                              <ImageWithBasePath src="assets/img/icons/smile-chat.svg" alt="Icon" />
                            </span>
                          </p>
                        ...
                        <div className="like-chat-grp">
                          <ul>
                            ...
                            <li className="comment-chat">
                              <Link to="#">
                                2
                                <ImageWithBasePath src="assets/img/icons/heart.svg" alt="Icon" />
                              </Link>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div className="chats forward-chat-msg">
                      ...
                      <div className="chat-content">
                        ...
                        <div className="message-content">Thank you for your support</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <Scrollbars>
                  <div className="left-chat-title d-flex justify-content-between align-items-center border-bottom-0">
                    ...
                    <div className="contact-close_call text-end">
                      ...
                      <Link to="#" className="close_profile close-trash" onClick={handleRemoveVisible}>
                        <i className="bx bx-trash" />
                      </Link>
                    </div>
                  </div>
                    ...
                    <div className="about-media-tabs">
                      <nav>
                        <div className="nav nav-tabs " id="nav-tab">
                          <Link className="nav-item nav-link active" id="nav-home-tab" data-bs-toggle="tab" to="#info">
                            Photos
                          </Link>
                          <Link
                          ...
                          <Link className="nav-item nav-link" id="nav-profile-tab2" data-bs-toggle="tab" to="#media">
                            File
                          </Link>
                          <Link className="nav-item nav-link" id="nav-profile-tab3" data-bs-toggle="tab" to="#link">
                            Link
                          </Link>
                        </div>
                      </nav>
                        ...
                        <div className="tab-pane fade" id="link">
                          <div className="media-link-grp">
                            <div className="link-img">
                              <Link to="#">
                                <ImageWithBasePath src="assets/img/media/media-link-01.jpg" alt="Img" />
                              </Link>
                            </div>
                            <div className="media-link-detail">
                              ...
                              <span>
                                <Link to="#">https://elements.envato.com/all-items/blog</Link>
                              </span>
                            </div>
                          </div>
                          <div className="media-link-grp mb-0">
                            <div className="link-img">
                              <Link to="#">
                                <ImageWithBasePath src="assets/img/media/media-link-02.jpg" alt="Img" />
                              </Link>
                            </div>
                            <div className="media-link-detail">
                              <h6>
                              ...
                              <span>
                                <Link to="#">https://elements.envato.com/blog-post-TXQ5FB8</Link>
                              </span>
                            </div>
                          </div>
                        </div>

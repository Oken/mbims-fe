...
import EditLowStock from '../../core/modals/inventory/edit-lows-tock';
        ...
        <div className="content">
          <div className="page-header">
            ...
            <ul className="table-top-head">
              ...
              <li>
                <Link to="" className="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#send-email">
                  <Mail className="feather-mail" />
                  <FeatherIcon icon="mail" className="feather-mail" />
                  Send Email
                </Link>
              </li>
              <li>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-12">
                            <div className="input-blocks">
                              ...
                              <FeatherIcon icon="archive" className="info-img" />
                              <Select
                                className="img-select"
                                options={warehouse}
                                classNamePrefix="react-select"

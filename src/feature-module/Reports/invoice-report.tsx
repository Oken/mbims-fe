...
const Invoicereport = () => {
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      render: (text) => (
        <div>
          {text === 'Paid' && <span className="badge badge-linesuccess">{text}</span>}
          {text === 'Unpaid' && <span className="badge badge-linedanger">{text}</span>}
          {text === 'Overdue' && <span className="badge badges-warning">{text}</span>}
        </div>
      ),
                    ...
                    <div className="input-blocks">
                      <div className="position-relative daterange-wraper">
                        ...
                        <DateRangePicker initialSettings={initialSettings}>
                          <input className="form-control col-4 input-range" type="text" />
                        </DateRangePicker>
                      </div>
                    </div>
                  </div>

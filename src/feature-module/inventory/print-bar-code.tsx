...
import BarcodePrinter from '../../core/modals/inventory/bar-code-printer';
      ...
      <div className="content">
        ...
        <div className="barcode-content-list">
              ...
              <div className="col-lg-6 col-12">
                <div className="row seacrh-barcode-item">
                  <div className="col-sm-6 mb-3 seacrh-barcode-item-one">
                    ...
                    <Select classNamePrefix="react-select" options={warehouseitems} placeholder="Choose" />
                  </div>
                  <div className="col-sm-6 mb-3 seacrh-barcode-item-one">
                    <label className="form-label">Select Store</label>
                    <Select classNamePrefix="react-select" options={selectstore} placeholder="Choose" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="input-blocks search-form seacrh-barcode-item">
                  <div className="searchInput">
                    ...
                    <div className="icon">
                      ...
                      <FeatherIcon icon="search" className="fas fa-search" />
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <tr>
                      ...
                      <td className="action-table-data justify-content-center">
                        <div className="edit-delete-action">
                          <Link onClick={showConfirmationAlert} className="confirm-text barcode-delete-icon" to="#">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="product-quantity">
                          ...
                          <input type="text" className="quantity-input" value={quantity1} readOnly />
                      ...
                      <td className="action-table-data justify-content-center">
                        <div className="edit-delete-action">
                          <Link onClick={showConfirmationAlert} className="barcode-delete-icon confirm-text" to="#">
                            <i data-feather="trash-2" className="feather-trash-2" />
                          </Link>
                        </div>
                      </td>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <form className="mb-0">
                  ...
                  <Select classNamePrefix="react-select" options={papersize} placeholder="Choose" />
                </form>
              </div>
          ...
          <div className="search-barcode-button">
            <Link to="#" className="btn btn-submit me-2" data-bs-toggle="modal" data-bs-target="#prints-barcode">
              <span>

...
import CustomerModal from '../../core/modals/peoples/customer-modal';
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        <Breadcrumbs maintitle="Customer List" subtitle="Manage Your Expense Category" addButton="Add New Customer" />

        ...
        <div className="row">
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                ...
                <p className="mt-1 f-m-light">
                  You may use predefined grid classes. Using <code>.col-md-* </code>you can set the grid system.
                </p>
              </div>
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                ...
                <p className="mt-1 f-m-light">
                  You can use the <code>align-items-*</code> class to set the vertical alignment.
                </p>
              </div>
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                ...
                <p className="mt-1 f-m-light">
                  You can use the <code>justify-content-*</code> class to set the horizontal alignment.
                </p>
              </div>
            ...
            <div className="card">
              <div className="card-header">
                ...
                <p className="mt-1 f-m-light">
                  ...
                  <code>.row</code> and set of <code>.col-sm-*</code> columns within an existing <code>.col-sm-*</code>{' '}
                  column.
                </p>
              </div>
              <div className="card-body grid-showcase">
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                ...
                <p className="mt-1 f-m-light">
                  Using <code>.order </code>class, you can set the order position.
                </p>
              </div>
              <div className="card-body grid-showcase">
                <div className="row g-2">
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                ...
                <p className="mt-1 f-m-light">
                  You can offset the grid column using <code>.offset-*</code> grid class.
                </p>
              </div>
              <div className="card-body grid-showcase">
                <div className="row g-2">
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p>
                  ...
                  <span className="text-danger">responsive display utilities.</span>
                </p>
                <div className="grid-showcase">
                  <div className="row">
          ...
          <div className="col-xl-12">
            <div className="card ">
              ...
              <div className="card-body">
                <p>
                  The <span className="text-danger">.col-*</span> classes can also be used outside a
                  <span className="text-danger">.row</span> to give an element a specific width. Whenever column classes
                  are used as non direct children of a row,the paddings are omitted.
                </p>
                <div className="grid-showcase">
                  <div className="col-3">
            ...
            <div className="card">
              <div className="card-body">
                <p>
                  ...
                  the content in a <span className="text-danger">.clearfix</span> wrapper to clear the float if the text
                  is shorter.
                </p>
                <div className="clearfix">
                  ...
                  <p>
                    ...
                    insights, or some hidden easter egg of content. A joke, perhaps. Unfortunately, there&apos;s none of
                    that here.{' '}
                  </p>
                </div>
              </div>

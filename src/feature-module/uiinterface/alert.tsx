      ...
      <div className="content">
        ...
        <div className="row">
              ...
              <div className="card-body">
                <div className="alert alert-solid-primary alert-dismissible fade show">
                  ...
                  <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close">
                    ...
                    <FeatherIcon icon="x" className="fas fa-mark" />
                  </button>
                </div>
                ...
                <div className="alert alert-solid-light alert-dismissible fade show">
                  ...
                  <button type="button" className="btn-close text-default" data-bs-dismiss="alert" aria-label="Close">
                    <i className="fas fa-xmark" />
                  </button>
                </div>
          ...
          <div className="col-xl-6">
            <div className="card">
              <div className="card-header justify-content-between">
                <div className="card-title">Rounded Alerts With Custom Close Button</div>
              </div>
              <div className="card-body">
                <div className="alert alert-primary rounded-pill alert-dismissible fade show">
                  A simple rounded primary alert—check it out!
                  <button type="button" className="btn-close custom-close" data-bs-dismiss="alert" aria-label="Close">
                    <i className="fas fa-xmark" />
                  </button>
                </div>
                <div className="alert alert-secondary rounded-pill alert-dismissible fade show">
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div
                  ...
                  role="alert"
                >
                  <i className="feather-info flex-shrink-0 me-2" />A customized primary alert with an icon
                  <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close">
                    <i className="fas fa-xmark" />
                  </button>
                </div>
                <div
                  ...
                  role="alert"
                >
                  <i className="feather-check-circle flex-shrink-0 me-2" />A customized secondary alert with an icon
                  <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close">
                    <i className="fas fa-xmark" />
                  </button>
                </div>
                <div
                  ...
                  role="alert"
                >
                  <i className="feather-alert-triangle flex-shrink-0 me-2" />A customized warning alert with an icon
                  <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close">
                    <i className="fas fa-xmark" />
                  </button>
                </div>
                <div
                  ...
                  role="alert"
                >
                  <i className="feather-alert-octagon flex-shrink-0 me-2" />A customized danger alert with an icon
                  <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close">
                    <i className="fas fa-xmark" />
                  </button>
                </div>
                      ...
                      <div className="alert alert-primary border border-primary mb-0 p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-primary w-100">
                            ...
                            <div className="fs-12 op-8 mb-1">Information alert to show to information message</div>
                            <div className="fs-12">
                              <Link to="#" className="text-secondary fw-semibold me-2 d-inline-block">
                                cancel
                              </Link>
                      ...
                      <div className="alert alert-secondary border border-secondary mb-0 p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-secondary w-100">
                            ...
                            <div className="fs-12 op-8 mb-1">Success alert to show to success message</div>
                            <div className="fs-12">
                              <Link to="#" className="text-danger fw-semibold me-2 d-inline-block">
                                cancel
                              </Link>
                              <Link to="#" className="text-secondary fw-semibold">
                                open
                              </Link>
                            </div>
                          </div>
                      ...
                      <div className="alert alert-warning border border-warning mb-0 p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-warning w-100">
                            ...
                            <div className="fs-12 op-8 mb-1">Warning alert to show warning message</div>
                            <div className="fs-12">
                              <Link to="#" className="text-dark fw-semibold me-2 d-inline-block">
                                cancel
                              </Link>
                      ...
                      <div className="alert alert-danger border border-danger mb-0 p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-danger w-100">
                            ...
                            <div className="fs-12 op-8 mb-1">Danger alert to show the danger message</div>
                            <div className="fs-12">
                              <Link to="#" className="text-info fw-semibold me-2 d-inline-block">
                                cancel
                              </Link>
                      ...
                      <div className="alert alert-solid-warning border border-warning mb-0 p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-fixed-white w-100">
                            ...
                            <div className="fs-12 op-8 mb-1">Warning alert to show to warning message</div>
                            <div className="fs-12">
                              <Link to="#" className="text-fixed-white fw-semibold me-2 op-7">
                                skip
                              </Link>
                      ...
                      <div className="alert alert-solid-danger border border-danger mb-0 p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div className="text-fixed-white w-100">
                            ...
                            <div className="fs-12 op-8 mb-1">Danger alert to show to danger message</div>
                            <div className="fs-12">
                              <Link to="#" className="text-fixed-white fw-semibold me-2 op-7">
                                close
                              </Link>
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="alert alert-img alert-primary alert-dismissible fase show flex-wrap" role="alert">
                ...
                <div className="alert alert-img alert-secondary alert-dismissible fase show flex-wrap" role="alert">
                ...
                <div className="alert alert-img alert-warning alert-dismissible fase show flex-wrap" role="alert">
                ...
                <div className="alert alert-img alert-danger alert-dismissible fase show flex-wrap" role="alert">
                ...
                <div className="alert alert-img alert-info alert-dismissible fase show flex-wrap" role="alert">
                ...
                <div className="alert alert-img alert-dark alert-dismissible fase show flex-wrap" role="alert">
                ...
                <div className="row gy-3">
                  <div className="col-xl-6">
                    <div className="alert alert-primary overflow-hidden p-0" role="alert">
                      ...
                      <div className="p-3">
                        <p className="mb-0">
                          We appreciate you to let us know the bug in the template and for warning us about future
                          consequences{' '}
                          <Link to="#" className="fw-semibold text-decoration-underline text-primary">
                    ...
                    <div className="alert alert-secondary overflow-hidden p-0" role="alert">
                      ...
                      <div className="p-3">
                        <p className="mb-0">
                          We appreciate you to let us know the bug in the template and for warning us about future
                          consequences{' '}
                          <Link to="#" className="fw-semibold text-decoration-underline text-secondary">
                            Visit for support for queries ?
                          </Link>
                        </p>
                      </div>
                  ...
                  <div className="col-xl-6">
                    <div className="alert alert-success overflow-hidden p-0" role="alert">
                      ...
                      <div className="p-3">
                        <p className="mb-0">
                          We appreciate you to let us know the bug in the template and for warning us about future
                          consequences{' '}
                          <Link to="#" className="fw-semibold text-decoration-underline text-success">
                            Visit for support for queries ?
                          </Link>
                        </p>
                      </div>
                    ...
                    <div className="alert alert-warning overflow-hidden p-0" role="alert">
                      ...
                      <div className="p-3">
                        <p className="mb-0">
                          We appreciate you to let us know the bug in the template and for warning us about future
                          consequences{' '}
                          <Link to="#" className="fw-semibold text-decoration-underline text-warning">
                            Visit for support for queries ?
                          </Link>
                        </p>
                      </div>

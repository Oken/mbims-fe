                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="card border shadow-none mb-0" aria-hidden="true">
                      <ImageWithBasePath src="assets/img/img-2.jpg" className="card-img-top" alt="..." />
                      <div className="card-body">
            ...
            <div className="card">
              <div className="card-body card-buttons">
                ...
                <p className="text-muted">
                  ...
                  <code>.col-6</code>) to set the <code>width</code>. They can replace the text inside an element or as
                  be added as a modifier class to an existing component.
                </p>
                <p aria-hidden="true">
                  <span className="placeholder col-6" />
                </p>
                <Link to="#" className="btn btn-primary disabled placeholder col-4" aria-hidden="true" />
              </div>
            </div>
            <div className="card">
              <div className="card-body card-buttons">

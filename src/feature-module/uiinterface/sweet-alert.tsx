...
const SweetAlert = () => {
  ...
  const displayAlert = (position: string) => {
    MySwal.fire({
  ...
  const showAlert1 = (title: string, p0: string) => {
    MySwal.fire({
      title: title,
  ...
  const showQuestionAlert = () => {
    MySwal.fire({
      ...
      confirmButtonText:
        '<span style="display: flex; align-items: center;">Next <i class="fas fa-arrow-right" style="margin-left: 5px;"></i></span>',

      cancelButtonText: 'Cancel',
    }).then((result) => {
      if (result.isConfirmed) {
        const answer1 = document.getElementById('swal-input1');
  ...
  const showQuestion2Alert = (answer1: any) => {
    MySwal.fire({
      ...
      html:
        `<p>Your answer from Question 1: <strong>${answer1}</strong></p>` +
      ...
      if (result.isConfirmed) {
        const answer2 = document.getElementById('swal-input2');
  ...
  const showQuestion3Alert = (answer1: any, answer2: any) => {
    MySwal.fire({
      ...
      html:
        `<p>Your answers from Questions 1 and 2: <strong>${answer1}</strong>, <strong>${answer2}</strong></p>` +
      ...
      if (result.isConfirmed) {
        const answer3 = document.getElementById('swal-input3');
        MySwal.fire({
          title: 'All Done',
            ...
            <div className="col-md-12">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p>
                    SweetAlert automatically centers itself on the page and looks great no matter if you are using a
                    desktop computer, mobile, or tablet. Its even highly customizable, as you can see below!
                  </p>
                  <button type="button" className="btn btn-outline-primary mr-1 mb-1 me-1" onClick={handleBasicAlert}>
                    Basic
                  </button>
                  <button type="button" className="btn btn-outline-primary mr-1 mb-1 me-1" onClick={handleWithTitle}>
                    With Title
                  </button>
                  <button type="button" className="btn btn-outline-primary mr-1 mb-1" onClick={handleFooterAlert}>
                    With Footer
                  </button>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p>
                    The type of the modal. SweetAlert comes with 4 built-in types which will show a corresponding icon
                    animation: &apos;warning&apos; &apos;error&apos;success&apos;info. You can also set it as
                    &apos;input to get a prompt modal. It can either be put in the object under the key &apos;icon or
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <button type="button" className="btn btn-outline-primary mr-1 mb-1" onClick={showQuestionAlert}>
                    Question
                  </button>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p>
                    Use <code>confirmButtonText: &quot;Your text here!</code> option to change the text of the
                    &quot;Confirm button.
                  </p>
                  ...
                  <button type="button" className="btn btn-outline-primary mb-2" onClick={showConfirmationAlert}>

                        ...
                        <ul className="w-100">
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="#" data-bs-toggle="modal" data-bs-target="#fb-connect">
                                {/* <Tool className="me-2" /> */}
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100">
                              <div className="security-type d-flex align-items-center">
                                <span className="system-app-icon">
                                  <ImageWithBasePath src="assets/img/icons/twitter-icon.svg" alt="" />
                                </span>
                                <div className="security-title">
                                  <h5>Twitter</h5>
                                </div>
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="#" data-bs-toggle="modal" data-bs-target="#twitter-connect">
                                {/* <Tool className="me-2" /> */}
                                <FeatherIcon icon="tool" className="me-2" />
                                Connect Now
                              </Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100">
                              <div className="security-type d-flex align-items-center">
                                <span className="system-app-icon">
                                  <ImageWithBasePath src="assets/img/icons/google-icon.svg" alt="" />
                                </span>
                                <div className="security-title">
                                  <h5>Google</h5>
                                </div>
                            ...
                            <p>Google has many special features to help you find exactly what you are looking for.</p>
                          </li>
                          <li>
                            <div className="integration-btn">
                              <Link to="#" data-bs-toggle="modal" data-bs-target="#google-connect">
                                {/* <Tool className="me-2" /> */}
                                <FeatherIcon icon="tool" className="me-2" />
                                Connect Now
                              </Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100">
                              <div className="security-type d-flex align-items-center">
                                <span className="system-app-icon">
                                  <ImageWithBasePath src="assets/img/icons/linkedin-icon.svg" alt="" />
                                </span>
                                <div className="security-title">
                                  <h5>Linkedin</h5>
                                </div>
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="#" data-bs-toggle="modal" data-bs-target="#linkedin-connect">
                                {/* <Tool className="me-2" /> */}
                                <FeatherIcon icon="tool" className="me-2" />
                                View Integration
                              </Link>

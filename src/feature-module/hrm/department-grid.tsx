...
import AddDepartment from '../../core/modals/hrm/add-department';
import EditDepartment from '../../core/modals/hrm/edit-department';
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <FeatherIcon icon="users" className="info-img" />
                        <Select
                          className="img-select"
                          classNamePrefix="react-select"
                          options={hodlist}
                        ...
                        <ul className="dropdown-menu">
                          <li>
                            ...
                            >
                              ...
                              <FeatherIcon icon="info-img" className="info-img" />
                              Edit
                            </Link>
                          </li>
                          <li>
                            <Link to="#" className="dropdown-item confirm-text mb-0" onClick={showConfirmationAlert}>
                              ...
                              <FeatherIcon icon="trash" className="info-img" />
                              Delete
                            </Link>
                          </li>
                        </ul>
                  ...
                  <ul className="team-members">
                    ...
                    <li>
                      <ul>
                        ...
                        <li>
                          <Link to="#">
                            <ImageWithBasePath src="assets/img/users/user-03.jpg" alt="" />
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                    ...
                    <div className="profile-head-action">
                      <div className="dropdown profile-action">
                        <Link
                          ...
                          aria-expanded="false"
                        >
                          <i data-feather="more-vertical" className="feather-user" />
                        </Link>
                        <ul className="dropdown-menu">
                          <li>
                            <Link

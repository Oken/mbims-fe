...
import TodoModal from '../../core/modals/applications/todo-modal';
          ...
          >
            <div className="notes-dash">
              <div className="notes-top-head">
                <h5>
                  {' '}
                  <i data-feather="file-text" className="feather-file-text me-1" />
                  Todo List
                </h5>
              </div>
              <div className="notes-top-head-subMenu">
                ...
                >
                  ...
                  >
                    {' '}
                    <i data-feather="check-circle" className="feather-check-circle me-2" />
                    Done
                  </button>
                  <button

                    ...
                    <div className="row">
                            ...
                            <table className="table  datanew">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <Select classNamePrefix="react-select" options={optionsAddition} />
                                  </td>
                      ...
                      <div className="col-lg-12">
                        <div className="input-blocks">
                          ...
                          <Select classNamePrefix="react-select" options={optionsStevenGravely} />
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-12">
              ...
              <div className="content">
                ...
                <div className="modal-body custom-modal-body">
                  <p>
                    ...
                    building its strategy to work with athletes to launch shows that could inspire consumers.Although
                    Jordan preferred Converse and Adidas, they simply could not match the offer Nike made. Jordan also
                    signed with Nike because he loved the way they wanted to market him with the banned colored shoes.

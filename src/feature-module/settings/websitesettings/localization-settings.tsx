...
import ReactTagsInput from '../react-tag-inputs';
                ...
                <div className="settings-page-wrap">
                  <form>
                    ...
                    <div className="company-info company-images">
                      ...
                      <div className="localization-info">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-sm-4">
                            <div className="localization-select">
                              <Select options={yearOptions} classNamePrefix="react-select" placeholder="Select Year" />
                            </div>
                          </div>
                        </div>
                        <div className="row align-items-center">
                    ...
                    <div className="company-info company-images">
                      ...
                      <div className="localization-info">
                        <div className="row align-items-center">
                          ...
                          <div className="col-sm-4">
                            <div className="localization-select">
                              <Select options={country} classNamePrefix="react-select" placeholder="Select Country" />{' '}
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-sm-4">
                        <div className="localization-select">
                          <Select options={symbols} classNamePrefix="react-select" placeholder="Select Country" />
                        </div>
                      </div>
                    </div>
                    <div className="row align-items-center">
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-sm-4">
                        <div className="localization-select">
                          <Select options={dot} classNamePrefix="react-select" placeholder="." />
                        </div>
                      </div>
                    </div>
                    <div className="row align-items-center">
                      ...
                      <div className="col-sm-4">
                        <div className="localization-select">
                          <Select options={comma} classNamePrefix="react-select" placeholder="," />
                        </div>
                      </div>
                    </div>

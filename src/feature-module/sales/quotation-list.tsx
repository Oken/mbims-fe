...
import AddQuotation from '../../core/modals/sales/add-quotation';
import EditQuotation from '../../core/modals/sales/edit-quotation';
...
const QuotationList = () => {
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      render: (text) => (
        <div>
          {text === 'Sent' && <span className="badges status-badge">{text}</span>}
          {text === 'Ordered' && <span className="badges order-badge">{text}</span>}
          {text === 'Pending' && <span className="badges unstatus-badge">{text}</span>}
        </div>
      ),

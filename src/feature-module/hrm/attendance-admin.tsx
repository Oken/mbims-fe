...
import { ChevronUp, RotateCcw, StopCircle, Layout } from "react-feather";
...
import AddAttendance from '../../core/modals/hrm/add-attendance';
import EditAttendance from '../../core/modals/hrm/edit-attendance';
import { ColumnsType } from 'antd/es/table';
import { attandanceadmindata } from '../../core/json/attendanceadmindata.js';
  ...
  const columns: ColumnsType<any> = [
    {
      ...
      render: (text, record) => (
        <div className="userimgname">
          ...
          <div className="emp-team">{text}</div>
        </div>
      ),

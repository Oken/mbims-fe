                ...
                <div className="modal-body custom-modal-body">
                  <form>
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" defaultValue="Lavish Warehouse" />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">Store</label>
                      <input type="text" className="form-control" defaultValue="Crinol" />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" defaultValue="Lenevo 3rd Gen" />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">SKU</label>
                      <input type="text" className="form-control" defaultValue="PT001" />
                    </div>
                    <div className="mb-3">

...
import AddUnit from '../../core/modals/inventory/add-unit';
import EditUnit from '../../core/modals/inventory/edit-unit';
            ...
            <div className="card-body">
              <div className="table-top">
                ...
                <div className="form-sort">
                  ...
                  <FeatherIcon icon="sliders" className="info-ing" />
                  <Select

...
import { ChevronUp, Info, ArrowLeft } from "react-feather";
                  ...
                  <div className="card-title-head">
                    <h6>
                      <span>
                        ...
                        <FeatherIcon icon="info" className="feather-edit" />
                      </span>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="mb-3">
                        ...
                        <Select classNamePrefix="react-select" options={types} placeholder="Choose" />
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="mb-3">
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="mb-3">
                        ...
                        <Select classNamePrefix="react-select" options={bloodgroup} placeholder="Choose" />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="mb-3">
                          ...
                          <Select classNamePrefix="react-select" options={country} placeholder="Select" />
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6">
                        <div className="mb-3">

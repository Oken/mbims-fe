...
export const setdashboard_recentproduct = (payload: any) => ({
  type: 'Dashbaord_RecentProduct',
  payload,
});
...
export const setdashboard_expiredproduct = (payload: any) => ({
  type: 'Dashbaord_ExpiredProduct',
  payload,
});
...
export const setattendenceemployee_data = (payload: any) => ({
  type: 'Attendenceemployee_Data',
  payload,
});

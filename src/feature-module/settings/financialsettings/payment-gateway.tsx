                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-01.svg" alt="Payment" />
                                </span>
                              </div>
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="#" data-bs-toggle="modal" data-bs-target="#payment-connect">
                                {/* <Tool className="me-2" /> */}
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-02.svg" alt="Payment" />
                                </span>
                              </div>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-03.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-04.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-05.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn">
                                <Link to="#">Connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-06.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-07.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn">
                                <Link to="#">Connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-08.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-09.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-10.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-11.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn">
                                <Link to="#">Connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-12.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-13.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-14.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn">
                                <Link to="#">Connected</Link>
                        ...
                        <ul className="w-100">
                          <li className="flex-column align-items-start">
                            <div className="d-flex align-items-center justify-content-between w-100 mb-2">
                              <div className="security-type d-flex align-items-center">
                                <span>
                                  <ImageWithBasePath src="assets/img/icons/payment-icon-15.svg" alt="Payment" />
                                </span>
                              </div>
                              <div className="connect-btn not-connect">
                                <Link to="#">Not connected</Link>

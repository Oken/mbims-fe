...
const TaxReport = () => {
  ...
  const handleSearch1 = (event: { target: { value: SetStateAction<string> } }) => {
  ...
  const columnsone: ColumnsType<any> = [
    {
      title: 'Supplier',
      dataIndex: 'Supplier',
          ...
          <div className="card-body">
            <div className="tabs-set">
              ...
              <div className="tab-content" id="myTabContent">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-2 col-sm-6 col-12">
                          <div className="input-blocks">
                            ...
                            <FeatherIcon icon="credit-card" className="info-img" />
                            <Select
                              className="img-select"
                              classNamePrefix="react-select"
                ...
                <div className="tab-pane fade" id="sales2" role="tabpanel" aria-labelledby="sales-tab">
                  <div className="table-top">
                    <div className="search-set">
                      <div className="search-input">
                        <input

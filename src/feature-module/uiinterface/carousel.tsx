                  ...
                  <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner" role="listbox">
                      <div className="carousel-item active">
                        <ImageWithBasePath className="d-block img-fluid" src="assets/img/img-1.jpg" alt="First slide" />
                      </div>
                      ...
                      <div className="carousel-item">
                        <ImageWithBasePath className="d-block img-fluid" src="assets/img/img-4.jpg" alt="Third slide" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-6">
              <div className="card">
                <div className="card-header">
                  ...
                  <p className="sub-header">Adding in the previous and next controls:</p>
                </div>
                <div className="card-body">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div id="carouselExampleCaption" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner" role="listbox">
                      <div className="carousel-item active">
                        <ImageWithBasePath src="assets/img/img-1.jpg" alt="Slide" className="d-block img-fluid" />
                      ...
                      <div className="carousel-item">
                        <ImageWithBasePath src="assets/img/img-2.jpg" alt="Slide" className="d-block img-fluid" />
                        <div className="carousel-caption d-none d-md-block">
                      ...
                      <div className="carousel-item">
                        <ImageWithBasePath src="assets/img/img-3.jpg" alt="Slide" className="d-block img-fluid" />
                        <div className="carousel-caption d-none d-md-block">
                ...
                <div className="card-body">
                  <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div className="carousel-inner">
                      ...
                      <div className="carousel-item">
                        <ImageWithBasePath className="d-block img-fluid" src="assets/img/img-3.jpg" alt="Third slide" />
                      </div>
                    </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner">
                      <div className="carousel-item active">
                        <ImageWithBasePath className="d-block img-fluid" src="assets/img/img-2.jpg" alt="First slide" />
                      </div>
                      <div className="carousel-item">
                        <ImageWithBasePath
                          className="d-block img-fluid"
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  >
                    <div className="carousel-inner">
                      <div className="carousel-item active">
                        <ImageWithBasePath src="assets/img/img-2.jpg" className="d-block w-100" alt="Slide" />
                      </div>
                      <div className="carousel-item">
                        <ImageWithBasePath src="assets/img/img-3.jpg" className="d-block w-100" alt="Slide" />
                      </div>
                      <div className="carousel-item">
                        <ImageWithBasePath src="assets/img/img-4.jpg" className="d-block w-100" alt="Slide" />
                      </div>
                    </div>
                    <button
                      className="carousel-control-prev"

...
import Table from '../../pagination/data-table';
...
const WareHouses = () => {
  ...
  const warehouselistdata: DataEntry[] = warehousedata;
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      render: (text) => (
        <span className={`badge ${text === 'Active' ? 'badge-linesuccess' : 'badge-bgdanger'}`}>{text}</span>
      ),
    },
      ...
      render: () => (
        <div className="action-table-data">
          <div className="edit-delete-action">
            <Link className="me-2 edit-icon p-2" to="#" data-bs-toggle="modal" data-bs-target="#edit-units">
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        <Breadcrumbs maintitle="Warehouse" subtitle="Manage Your Warehouse" addButton="Add New Warehouse" />

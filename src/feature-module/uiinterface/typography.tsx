          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="mb-1">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum dolorem fuga iste obcaecati natus eos
                    officiis adipisci voluptatibus ipsum, architecto veniam delectus vel dolor magni a vero sunt ut
                    harum.
                  </p>
                  ...
                  <p className=" mb-1">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iusto perspiciatis, magni numquam quos
                    perferendis nulla magnam odit amet excepturi quisquam provident.
                  </p>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted mb-0">
                    Muted text with a{' '}
                    <a href="#" className="text-reset text-decoration-underline text-dark">
                      reset link
                    </a>
                    .
                  </p>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="text-muted mb-2">
                    {' '}
                    use class <code>.text-nowrap</code> to prevent text from wrapping
                  </p>
                  <div className="text-nowrap bg-light border text-dark" style={{ width: '8rem' }}>

...
import AddLeaveEmployee from '../../core/modals/hrm/add-leave-employee';
import EditLeaveEmployee from '../../core/modals/hrm/edit-leave-employee';
...
const LeavesEmployee = () => {
  const leavesEmployeedata: DataEntry[] = leavesEmployee;

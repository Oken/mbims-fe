            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-header">
                  ...
                  <p className="text-muted mb-0">
                    Use a classes <code>.btn-soft-**</code> to quickly create a bordered buttons.
                  </p>
                </div>
                <div className="card-body">
                  <div className="btn-list">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list">
                    ...
                    <button type="button" className="btn btn-square btn-outline-secondary">
                      Secondary
                    </button>
                    <button type="button" className="btn btn-square btn-outline-success">
                      Success
                    </button>
                    <button type="button" className="btn btn-square btn-outline-danger">
                      Danger
                    </button>
                    <button type="button" className="btn btn-square btn-outline-warning">
                      Warning
                    </button>
                    <button type="button" className="btn btn-square btn-outline-info">
                      Info
                    </button>
                    <button type="button" className="btn btn-square btn-outline-light">
                      Light
                    </button>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="btn-list">
                    ...
                    <input className="btn btn-primary me-1" type="button" defaultValue="Input" />
                    <input className="btn btn-primary me-1" type="submit" defaultValue="Submit" />
                    <input className="btn btn-primary me-1" type="reset" defaultValue="Reset" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-header">
                  ...
                  <p className="text-muted mb-0">
                    Use a classes <code>.btn-icon</code> to quickly create a bordered buttons.
                  </p>
                </div>
                <div className="card-body">

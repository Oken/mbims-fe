          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted mb-3">
                    You can use <code>&lt;a&gt;</code> or <code>&lt;button&gt;</code> as dropdown items.
                  </p>
                  <div className="dropdown">
                    <button
                      className="btn btn-info dropdown-toggle"
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted mb-3">
                    Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change the location of the
                    dropdown.
                  </p>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p className="card-title mb-3">
                    Use <code>.dropdown-item-text.</code> to create non-interactive dropdown items.
                  </p>
            ...
            <div className="col-xl-3">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="card-title mb-3">
                    Add a <code>.dropdown-header</code> to label sections of actions in any dropdown menu.
                  </p>
                  <div className="bd-example">
                    <ul className="dropdown-menu">
                      <li>
                ...
                <div className="card-body">
                  <div className="bd-example">
                    <div className="dropdown-menu p-4 text-muted" style={{ maxWidth: 200 }}>
                      <p>Some example text that&aposs free-flowing within the dropdown menu.</p>

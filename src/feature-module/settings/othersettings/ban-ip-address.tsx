...
import EditIpAddress from '../../../core/modals/settings/edit-ip-address';
import AddIpAddress from '../../../core/modals/settings/add-ip-address';
      ...
      render: () => (
        <div className="action-table-data justify-content-end">
          <div className="edit-delete-action">
            <a className="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#edit-banip">
              <i className="feather-edit" style={{ cursor: 'pointer' }}></i>
            </a>
            <a className="confirm-text p-2" href="#" onClick={showConfirmationAlert}>
                ...
                <div className="settings-page-wrap w-50">
                  ...
                  <div className="page-header bank-settings justify-content-end">
                    <div className="page-btn">
                      <Link to="#" className="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-banip">

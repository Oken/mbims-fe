                    ...
                    <div className="new-employee-field">
                      <div className="profile-pic-upload">
                        <div className="profile-pic">
                          <span>
                            <i data-feather="plus-circle" className="plus-down-add" /> Add Image
                          </span>
                        </div>
                        <div className="mb-3">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6 pe-0">
                        <div className="mb-3">
                          ...
                          <Select classNamePrefix="react-select" options={countriesOptions} />
                        </div>
                      </div>
                  ...
                  <form>
                    ...
                    <div className="new-employee-field">
                      <div className="profile-pic-upload">
                        <div className="profile-pic people-profile-pic">
                          <ImageWithBasePath src="assets/img/profiles/profile.png" alt="Img" />
                          <Link to="#">
                    ...
                    <div className="row">
                      <div className="col-lg-4 pe-0">
                        <div className="mb-3">
                          <label className="form-label">Customer Name</label>
                          <input type="text" className="form-control" defaultValue="Thomas" />
                        </div>
                      </div>
                      <div className="col-lg-4 pe-0">
                        <div className="mb-3">
                          <label className="form-label">Email</label>
                          <input type="email" className="form-control" defaultValue="thomas@example.com" />
                        </div>
                      </div>
                      <div className="col-lg-4 pe-0">
                        <div className="input-blocks">
                      ...
                      <div className="col-lg-12 pe-0">
                        <div className="mb-3">
                          <label className="form-label">Address</label>
                          <input type="text" className="form-control" defaultValue="Budapester Strasse 2027259 " />
                        </div>
                      </div>
                      <div className="col-lg-6 pe-0">
                        <div className="mb-3">

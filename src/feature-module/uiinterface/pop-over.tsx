...
const Popovers = () => {
  ...
  const createPopover = (p0: string, p1: string, p2: string, p3: string, props: PopOverT) => (
    <Popover id={props.id} className={props.customClass}>
      <Popover.Header as="h3">{props.title}</Popover.Header>
      <Popover.Body>{props.content}</Popover.Body>
    </Popover>
  );

  const createPopoverLight = (p0: string, p1: string, p2: string, p3: string, props: PopOverT) => (
    <Popover id={props.id} className={props.customClass}>
      <Popover.Header as="h3">{props.title}</Popover.Header>
      <Popover.Body>{props.content}</Popover.Body>
    </Popover>
  ...
  const createPopoverDark = (p0: string, p1: string, p2: string, p3: string, props: PopOverT) => (
    <Popover id={props.id} className={props.customClass}>
      <Popover.Header as="h3">{props.title}</Popover.Header>
      <Popover.Body>{props.content}</Popover.Body>
    </Popover>
  ...
  const createPopoverDismiss = (p0: string, p1: string, p2: string, props: PopOverT) => (
    <Popover id={props.id} className={props.customClass}>
      <Popover.Header as="h3">{props.title}</Popover.Header>
      <Popover.Body>{props.content}</Popover.Body>
    </Popover>
  ...
  const popoverSecondary = (
    <Popover id="popover-secondary">
      <Popover.Body>This popover is used to provide information about this icon.</Popover.Body>
    </Popover>
  );
  return (
        ...
        <div className="row">
              ...
              <div className="card-body">
                <div className="btn-list popover-list">
                  <OverlayTrigger
                    ...
                    overlay={popoverTop}
                  >
                    <Link to="" tabIndex={0} className="btn btn-outline-primary btn-wave">
                      Popover Top
                    </Link>
                  </OverlayTrigger>
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="btn-list popover-list">
                  <OverlayTrigger trigger="click" placement="top" overlay={popoverTitle}>
                  ...
                  <OverlayTrigger trigger="focus" placement="top" overlay={popover1}>
                    <Link to="" className="example-popover btn btn-primary" tabIndex={0}>
                      Dismissible popover
                    </Link>
                  </OverlayTrigger>

                  <OverlayTrigger trigger={['hover', 'focus']} placement="bottom" overlay={popover2}>
                    <button className="example-popover btn btn-primary" type="button">
                      On Hover Tooltip
                    </button>
                  </OverlayTrigger>
                </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="btn-list popover-list">
                  ...
                  >
                    <button type="button" className="btn btn-outline-primary btn-wave">
                      Header Primary
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-outline-info btn-wave">
                      Header Info
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-outline-warning btn-wave">
                      Header Warning
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-outline-success btn-wave">
                      Header Success
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-outline-danger btn-wave">
                      Header Danger
                    </button>
                  </OverlayTrigger>
                </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="btn-list popover-list">
                  ...
                  >
                    <button type="button" className="btn btn-secondary btn-wave">
                      Secondary
                    </button>
                  </OverlayTrigger>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="btn-list popover-list">
                  ...
                  >
                    <button type="button" className="btn btn-soft-primary btn-wave">
                      Primary
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-soft-secondary btn-wave">
                      Secondary
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-soft-info btn-wave">
                      Info
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-soft-warning btn-wave">
                      Warning
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-soft-success btn-wave">
                      Success
                    </button>
                  </OverlayTrigger>
                  ...
                  >
                    <button type="button" className="btn btn-soft-danger btn-wave">
                      Danger
                    </button>
                  </OverlayTrigger>
                </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <OverlayTrigger
                  trigger={['hover', 'focus']}
                  placement="auto"
                  overlay={createPopoverDisable('popover-disabled', 'Disabled popover')}
                >
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <OverlayTrigger trigger="click" placement="top" overlay={popoverPrimary}>
                  <Link className="me-4">
                    <AlertCircle className="text-primary" />
                  </Link>
                </OverlayTrigger>

                <OverlayTrigger trigger="click" placement="left" overlay={popoverSecondary}>
                  <Link className="me-4">

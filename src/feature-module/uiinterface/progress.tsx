            ...
            <div className="card">
              ...
              <div className="card-body">
                <div
                  ...
                  aria-valuemax={100}
                >
                  <div className="progress-bar bg-secondary" style={{ width: '20%' }} />
                </div>
                <div
                  className="progress mb-3"
                  role="progressbar"
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="progress" role="progressbar" aria-valuenow={100} aria-valuemin={0} aria-valuemax={100}>
                  <div className="progress-bar progress-bar-striped bg-warning" style={{ width: '100%' }} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div
                  ...
                  aria-valuemax={100}
                >
                  <div className="progress-bar bg-primary-gradient" style={{ width: '10%' }} />
                </div>
                <div
                  className="progress mb-3 progress-animate"
                  role="progressbar"
                  ...
                  aria-valuemax={100}
                >
                  <div className="progress-bar bg-secondary-gradient" style={{ width: '20%' }} />
                </div>
                <div
                  className="progress mb-3 progress-animate"
                  role="progressbar"
                  ...
                  aria-valuemax={100}
                >
                  <div className="progress-bar bg-success-gradient" style={{ width: '40%' }} />
                </div>
                <div
                  className="progress mb-3 progress-animate"
                  role="progressbar"
                  ...
                  aria-valuemax={100}
                >
                  <div className="progress-bar bg-info-gradient" style={{ width: '60%' }} />
                </div>
                <div
                  ...
                  aria-valuemax={100}
                >
                  <div className="progress-bar bg-warning-gradient" style={{ width: '80%' }} />
                </div>
              </div>
            </div>
          </div>

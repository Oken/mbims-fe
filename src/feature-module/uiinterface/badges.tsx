          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body d-flex flex-wrap gap-2">
                  <span className="badge rounded-pill bg-outline-primary">Primary</span>
                  <span className="badge rounded-pill bg-outline-secondary">Secondary</span>
                  <span className="badge rounded-pill bg-outline-success">Success</span>
                  <span className="badge rounded-pill bg-outline-danger">Danger</span>
                  <span className="badge rounded-pill bg-outline-warning">Warning</span>
                  <span className="badge rounded-pill bg-outline-info">Info</span>
                  <span className="badge rounded-pill bg-outline-light text-dark">Light</span>
                  <span className="badge rounded-pill bg-outline-dark text-dark">Dark</span>
                </div>
              </div>
            </div>
            {/* /Outline Rounded Badges */}
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body d-flex flex-wrap gap-2">
                  <span className="badge rounded-pill bg-soft-primary">Primary</span>
                  <span className="badge rounded-pill bg-soft-secondary">Secondary</span>
                  <span className="badge rounded-pill bg-soft-success">Success</span>
                  <span className="badge rounded-pill bg-soft-danger">Danger</span>
                  <span className="badge rounded-pill bg-soft-warning">Warning</span>
                  <span className="badge rounded-pill bg-soft-info">Info</span>
                  <span className="badge rounded-pill bg-soft-light text-dark">Light</span>
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body d-flex flex-wrap gap-2">
                  <button type="button" className="btn btn-outline-primary my-1 me-2">
                    Notifications <span className="badge bg-primary ms-2">3</span>
                  </button>
                  <button type="button" className="btn btn-outline-success my-1 me-2">
                    Notifications <span className="badge bg-success ms-2">15</span>
                  </button>
                  <button type="button" className="btn btn-outline-danger my-1 me-2">
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <span className="badge bg-outline-danger me-1">
                        <span className="badge-label">Danger</span>
                        <span>
                          {/* <X className="x" style={{ height: 12, width: 12 }} /> */}
                          <FeatherIcon icon="x" className="ms-1" />
                        </span>
                      </span>
                    </div>

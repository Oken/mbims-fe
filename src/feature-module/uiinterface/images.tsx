        ...
        <div className="row">
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                <ImageWithBasePath className="rounded float-start" src="assets/img/img-1.jpg" alt="..." width={200} />
              </div>
            </div>
          </div>
          {/* /Image Left Align */}
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                <ImageWithBasePath className="rounded float-end" src="assets/img/img-1.jpg" alt="..." width={200} />
              </div>
            </div>
          </div>
          {/* /Image Right Align */}

...
const SalesList = () => {
  ...
  const filteredData = saleslistdata.filter((entry) => {
    return Object.keys(entry).some((key) => {
      return String((entry as Record<string, string>)[key])
        .toLowerCase()
  ...
  const columns: ColumnsType<any> = [
...

    {
      ...
      dataIndex: 'status',
      render: (text) => (
        <span className={`badge ${text === 'Completed' ? 'badge-bgsuccess' : 'badge-bgdanger'}`}>{text}</span>
      ),
    ...
    },
    {
      ...
      render: (text) => (
        <span className={`badge ${text === 'Paid' ? 'badge-linesuccess' : 'badge-linedanger'}`}>{text}</span>
      ),
          ...
          <ul className="dropdown-menu">
            <li>
              <Link to="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#sales-details-new">
                <i data-feather="eye" className="feather-eye me-2"></i>Sale Detail
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#showpayment">
                <i data-feather="dollar-sign" className="feather-dollar-sign"></i>Show Payments
              </Link>
            </li>
            <li>
              <Link to="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#createpayment">
                <i data-feather="plus-circle" className="feather-plus-circle me-2"></i>Create Payment
              </Link>
            </li>
            <li>
              <Link to="#" className="dropdown-item">
                <i data-feather="download" className="feather-edit me-2"></i>Download pdf
              </Link>
            </li>
            <li>
              <Link to="#" className="dropdown-item confirm-text mb-0" onClick={showConfirmationAlert}>
                <i data-feather="trash-2" className="feather-trash me-2"></i>Delete Sale
              </Link>
            </li>
          </ul>
        </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <FeatherIcon icon="file-text" className="info-img" />
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        {/* <StopCircle className="info-img" /> */}
                        <FeatherIcon icon="usestop-circler" className="info-img" />
                        <Select
                          className="img-select"
                          classNamePrefix="react-select"
                        ...
                        <div className="row">
                            ...
                            <div className="input-blocks">
                              ...
                              <div className="row">
                                <div className="col-lg-10 col-sm-10 col-10">
                                  <Select classNamePrefix="react-select" options={customer} placeholder="Newest" />
                                </div>
                                <div className="col-lg-2 col-sm-2 col-2 ps-0">
                                  <div className="add-icon">
                                    <Link to="#" className="choose-add">
                                      {/* <PlusCircle className="plus" /> */}
                                      <FeatherIcon icon="plus-circle" className="plus" />
                                    </Link>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div className="col-lg-4 col-sm-6 col-12">
                            <div className="input-blocks">
                              ...
                              <Select classNamePrefix="react-select" options={suppliername} placeholder="Newest" />
                            </div>
                          </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-12">
                            <div className="input-blocks mb-5">
                              <label>Status</label>
                              <Select classNamePrefix="react-select" options={statusupdate} placeholder="status" />
                            </div>
                          </div>
                    ...
                    <ul className="table-top-head">
                      <li>
                        <Link to="" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf">
                          <i data-feather="edit" className="feather-edit sales-action" />
                        </Link>
                      </li>
                      <li>
                        <Link to="" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf">
                      ...
                      <form>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-12">
                            <div className="input-blocks mb-5">
                              <label>Status</label>
                              <Select classNamePrefix="react-select" options={statusupdate} placeholder="Newest" />
                            </div>
                          </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-sm-12 col-12">
                      <div className="input-blocks">
                        ...
                        <Select classNamePrefix="react-select" options={paymenttype} placeholder="Newest" />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="input-blocks">

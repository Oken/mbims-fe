...
import SupplierModal from '../../core/modals/peoples/supplier-modal';
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        <Breadcrumbs maintitle="Supplier List " subtitle="Manage Your Supplier" addButton="Add New Supplier" />
        {/* /product list */}

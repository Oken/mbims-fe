    ...
    <div className="main-wrapper login-body">
      <div className="login-wrapper">
        <div className="container">
          <ImageWithBasePath className="img-fluid logo-dark mb-5" src="assets/img/logo.png" alt="Logo" />
          <div className="loginbox">
            <div className="login-right">
              <div className="login-right-wrap">
                <div className="login-info">
                  <p className="account-subtitle">Welcome back!</p>
                  <ImageWithBasePath src="assets/img/login-user.png" className="img-fluid" alt="User-Img" />
                  <h5>John Smilga</h5>
                </div>
                <form action="#">
                  ...
                  <Link className="btn btn-lg btn-block btn-primary" to={route.dashboard}>
                    Log In
                  </Link>
                </form>
              </div>

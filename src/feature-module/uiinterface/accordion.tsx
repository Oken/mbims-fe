                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        <strong>This is the first item's accordion body.</strong> It is shown by default, until the
                        collapse plugin adds the appropriate classes that we use to style each element. These classes
                        control the overall appearance, as well as the showing and hiding via CSS transitions. It's also
        ...
        <div className="row">
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-secondary" id="accordionSecondaryExample">
                  <div className="accordion-item">
        ...
        <div className="row">
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-solid-primary" id="accordionPrimarySolidExample">
                  <div className="accordion-item">
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-solid-secondary" id="accordionSecondarySolidExample">
                  <div className="accordion-item">
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingSecondarySolidThree">
                      <button
                        className="accordion-button collapsed"
                        type="button"
                        data-bs-toggle="collapse"
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-solid-warning" id="accordionWarningSolidExample">
                  <div className="accordion-item">
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-solid-info" id="accordionInfoSolidExample">
                  <div className="accordion-item">
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-solid-success" id="accordionSuccessSolidExample">
                  <div className="accordion-item">
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordion-solid-danger" id="accordionDangerSolidExample">
                  <div className="accordion-item">
        ...
        <div className="row">
          ...
          <div className="col-xl-6">
            <div className="card">
              ...
              <div className="card-body">
                <div className="accordion accordionicon-none accordions-items-seperate" id="accordioniconnoIconExample">
                  <div className="accordion-item">

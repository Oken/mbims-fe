...
import FileModal from '../../core/modals/applications/file-modal';
...
const FileManager = () => {
  ...
  return (
    <div className={`page-wrapper notes-page-wrapper file-manager ${isOpen && 'notes-tag-left'}`}>
      <div className="content">
        <div className="page-header page-add-notes flex-sm-row flex-column">
          ...
          <div className="d-flex flex-sm-row flex-column align-items-sm-center align-items-start">
            ...
            <Link to="#" className="btn btn-primary btn-added" data-bs-toggle="modal" data-bs-target="#upload-file">
              <span className="me-1 d-flex align-items-center">
                {/* <Upload className="feather-16" /> */}
                <FeatherIcon icon="upload" className="feather-16" />
              </span>
              Upload Files
            </Link>
          </div>
        ...
        <div className="row">
            ...
            <div className="stickybar">
              <aside className="card file-manager-sidebar mb-0">
                ...
                <div className="space-manager p-4">
                  <ImageWithBasePath src="assets/img/icons/half-circle.svg" alt="Folder" />
                  <h6>
          ...
          <div className={`col-lg-9 budget-role-notes  ${isOpen && 'budgeted-role-notes'}`}>
            {isOpen ? (
              <FileContent />
            ) : (
              // <Scrollbars>

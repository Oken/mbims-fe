                ...
                <ul>
                  <li className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center w-85">
                      <img src="assets/img/icons/folder.svg" alt="Folder" className="me-2" />
                      <div className="flex-fill">
                        <h6>
                          <Link to="#">
                            latest-version.zip
                            <i data-feather="check-circle" className="ms-2 feather-16" />
                          </Link>
                        </h6>
                        <span>616 MB</span>
                      </div>
                  ...
                  <li className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center w-85">
                      <img src="assets/img/icons/xls.svg" alt="Folder" className="me-2" />
                      <div className="flex-fill">
                        <h6>
                    ...
                    <div className="d-flex align-items-center">
                      <Link to="#" className="text-danger me-2 d-flex align-items-center">
                        <i data-feather="trash-2" className="feather-16" />
                      </Link>
                      <Link to="#" className="text-default d-flex align-items-center">
                  ...
                  <li className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center w-85">
                      <img src="assets/img/icons/zip.svg" alt="Folder" className="me-2" />
                      <div className="flex-fill">
                        <h6>

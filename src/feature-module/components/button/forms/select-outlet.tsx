...
type SelectOutletProps = {
  ...
  removeStoreModalPrice: boolean;
  setOutlets: (value: CustomStoreFormDataT[]) => void;
};
          ...
          columns={
            trackInventory ?
              ...
              columns.filter((column: any) => {
                ...
                if (column.dataIndex === 'price' && removeStoreModalPrice) return false;
                return true
              })
          }

...
const SupplierReport = () => {
  ...
  const filteredData = data.filter((entry) => {
    return Object.keys(entry).some((key: any) => {
      return String((entry as Record<string, any>)[key])
        .toLowerCase()
  ...
  const columnsreturnsupplier: ColumnsType<any> = [
    {
      title: 'Reference',
      dataIndex: 'reference',
    ...
    },
    {
      ...
      render: (text) => (
        <div>
          ...
          {text === 'Unpaid' && <span className="badge badge-linedanger">{text}</span>}
  ...
  const columnpayment: ColumnsType<any> = [
    {
      title: 'Date',
      dataIndex: 'Date',
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        <Breadcrumbs maintitle="Supplier Report" subtitle="Manage Your Supplier Report" />
        <div className="table-tab">
          ...
          <div className="tab-content" id="pills-tabContent">
                      ...
                      <div className="row">
                        <div className="col-lg-2 col-sm-6 col-12">
                          <div className="input-blocks">
                            ...
                            <Select className="img-select" classNamePrefix="react-select" options={productOptions} />
                          </div>
                        </div>
                        <div className="col-lg-2 col-sm-6 col-12">
                          <div className="input-blocks">
                            <StopCircle className="info-img" />
                            <Select className="img-select" classNamePrefix="react-select" options={statusOptions} />
                          </div>
                        </div>
                        <div className="col-lg-2 col-sm-6 col-12">
                          <div className="input-blocks">
            ...
            <div className="tab-pane fade" id="payment-report" role="tabpanel" aria-labelledby="payment-report-tab">
              {/* /product list */}
              <div className="card table-list-card">
                <div className="card-body">
                  <div className="table-top">
                    ...
                    <div className="search-path">
                      <Link
                        ...
                        id="filter_search"
                      >
                        <Filter className="filter-icon" onClick={toggleFilterVisibilityTwo} />
            ...
            <div className="tab-pane fade" id="return-report" role="tabpanel" aria-labelledby="return-report-tab">
              {/* /product list */}
              <div className="card table-list-card">
                <div className="card-body">
                  <div className="table-top">
                    ...
                    <div className="search-path">
                      <Link
                        ...
                        id="filter_search"
                      >
                        <Filter className="filter-icon" onClick={toggleFilterVisibilityThree} />
                    ...
                    <div className="card-body pb-0">
                      <div className="row">
                        <div className="col-lg-3 col-sm-6 col-12">
                          <div className="input-blocks">
                            <User className="info-img" />
                            <Select className="img-select" classNamePrefix="react-select" options={nameOptions} />
                          </div>
                        </div>
                        <div className="col-lg-3 col-sm-6 col-12">
                          <div className="input-blocks">
                            <StopCircle className="info-img" />
                            <Select className="img-select" classNamePrefix="react-select" options={statusOptions2} />
                          </div>
                        </div>
                        <div className="col-lg-3 col-sm-6 col-12">
                          <div className="input-blocks">

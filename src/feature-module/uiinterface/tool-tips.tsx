...
const Tooltips = () => {
  ...
  const tooltipContentDisable = <Tooltip id="disabled-tooltip">Disabled tooltip</Tooltip>;
                  ...
                  <div className="btn-list">
                    ...
                    >
                      <OverlayTrigger placement="top" overlay={renderTooltipSecondary} offset={[0, 15]}>
                        <span className="d-inline-block">Secondary Tooltip</span>
                      </OverlayTrigger>
                    </button>
                    <button
                      type="button"
          ...
          <div className="row">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="popover-list">
                    <OverlayTrigger placement="top" overlay={renderTooltipHover} delay={{ show: 250, hide: 400 }}>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="tooltip-list">
                    ...
                    <OverlayTrigger placement="left" overlay={<Tooltip id="tooltip-bottom">Tooltip on left</Tooltip>}>
                      <button type="button" className="btn btn-primary me-2">
                        Tooltip on left
                      </button>
                    </OverlayTrigger>
            ...
            <div className="col-md-6">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="popover-list">
                    <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-html">{tooltipContent}</Tooltip>}>
                      <button type="button" className="btn btn-primary me-2">
                        Tooltip with HTML
                      </button>
                    </OverlayTrigger>
                    <OverlayTrigger trigger="click" placement="bottom" overlay={tooltipContenthtml}>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <span className="d-inline-block" tabIndex={0} data-bs-toggle="tooltip">
                    <OverlayTrigger placement="top" overlay={tooltipContentDisable}>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted mb-0">
                    ...
                    <OverlayTrigger placement="top" overlay={tooltipContentLink}>

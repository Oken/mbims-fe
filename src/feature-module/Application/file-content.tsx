...
const FileContent = () => {
  const columns: ColumnsType<any> = [
    {
      ...
      render: (text, record) => (
        <div className="productimgname">
          <Link to="product-list.html" className="product-img d-flex align-items-center">
  ...
  const datas: DataEntry[] = fileManagerData;
    ...
    <>
          ...
          <div className="section-bulk-wrap">
            <div className="bulk-action-type col-lg-6 col-md-6">
              <div className="form-sort select-bluk">
                <Select classNamePrefix="react-select" options={options2} placeholder="Sort by Date" />
              </div>
            ...
            <div className="d-sm-flex align-items-center col-lg-6 col-md-6 justify-content-end">
              <div className="form-sort me-3">
                ...
                <Select className="img-select" classNamePrefix="react-select" options={options3} placeholder="Recent" />
              </div>
        ...
        <div className="row g-3">
          <div className="col-sm-6 col-md-3">
            <div className="detail">
              <Link to="#" className="d-flex align-items-center justify-content-center bg-light-orange bg p-4">
          ...
          <div className="col-sm-6 col-md-3">
            <div className="detail">
              <Link to="#" className="d-flex align-items-center justify-content-center bg-light-red bg p-4">
                <span className="d-flex align-items-center justify-content-center">
          ...
          <div className="col-sm-6 col-md-3">
            <div className="detail">
              <Link to="#" className="d-flex align-items-center justify-content-center bg-light-green bg p-4">
                <span className="d-flex align-items-center justify-content-center">
      ...
      <div className="accordion" id="accordionPanelsStayOpenExample">
              ...
              <Slider {...settings} className="folders-carousel d-flex">
                <div className="folders p-3 me-3">
                  <div className="d-flex align-items-center justify-content-between head">
                    <div className="d-flex align-items-center">
                      <ImageWithBasePath src="assets/img/icons/folder.svg" alt="Folder" className="me-2" />
                  ...
                  <div className="d-flex align-items-center justify-content-between avatar-wrap">
                    <div className="group-avatar">
                      <span className="avatar">
                        ...
                        >
                          <ImageWithBasePath src="assets/img/avatar/avatar-2.jpg" alt="Avatar" />
                        </Link>
                      </span>
                      <span className="avatar">
                        <Link
                        ...
                        >
                          <ImageWithBasePath src="assets/img/avatar/avatar-1.jpg" alt="Avatar" />
                        </Link>
                      </span>
                  ...
                  <div className="d-flex align-items-center justify-content-between avatar-wrap">
                    <div className="group-avatar">
                      ...
                      <span className="avatar">
                        ...
                        >
                          <ImageWithBasePath src="assets/img/avatar/avatar-3.jpg" alt="Avatar" />
                        </Link>
                      </span>
                      <span className="avatar">
                        <Link
                        ...
                        >
                          <ImageWithBasePath src="assets/img/avatar/avatar-4.jpg" alt="Avatar" />
                        </Link>
                      </span>
                      <span className="count">
                        <Link to="#">1 Members</Link>
        ...
        <div className="accordion-item seprator-lg">
          ...
          >
            <div className="accordion-body">
              <Slider {...settings2} className="files-carousel owl-theme d-flex">
                <div className="folders p-3 me-2">
                  <div className="d-flex align-items-center justify-content-between head">
                    <div className="d-flex align-items-center">
                      <ImageWithBasePath src="assets/img/icons/pdf-02.svg" alt="File" className="me-2" />
                      <h6 className="popup-toggle">
                ...
                <div className="folders p-3">
                  <div className="d-flex align-items-center justify-content-between head">
                    <div className="d-flex align-items-center">
                      <ImageWithBasePath src="assets/img/icons/xls.svg" alt="File" className="me-2" />
                      <h6 className="popup-toggle">

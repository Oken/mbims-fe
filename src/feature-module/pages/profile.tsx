              ...
              <div className="profile-top">
                <div className="profile-content">
                  <div className="profile-contentimg">
                    <ImageWithBasePath src="assets/img/customer/customer5.jpg" alt="img" id="blah" />
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-sm-12">
                <div className="input-blocks">
                  ...
                  <input type="text" className="form-control" defaultValue="Castilo" />
                </div>
              </div>
              <div className="col-lg-6 col-sm-12">
                <div className="input-blocks">
                  <label>Email</label>
                  <input type="email" className="form-control" defaultValue="william@example.com" />
                </div>
              </div>
              <div className="col-lg-6 col-sm-12">
                <div className="input-blocks">
              ...
              <div className="col-lg-6 col-sm-12">
                <div className="input-blocks">
                  ...
                  <input type="text" className="form-control" defaultValue="William Castilo" />
                </div>
              </div>
              <div className="col-lg-6 col-sm-12">
                <div className="input-blocks">

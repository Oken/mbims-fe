...
import AddSalesReturns from '../../core/modals/sales/add-sales-returns';
import EditSalesRetuens from '../../core/modals/sales/edit-sales-retuens';
...
const SalesReturn = () => {
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      render: (text) => (
        <div>
          {text === 'Received' && <span className="badges bg-lightgreen">{text}</span>}
          {text === 'Pending' && <span className="badges bg-lightred">{text}</span>}
          {text === 'Ordered' && <span className="badges bg-lightyellow">{text}</span>}
        </div>
      ),
    ...
    },
    {
      ...
      render: (text) => (
        <div>
          {text === 'Paid' && <span className="badges bg-lightgreen">{text}</span>}
          {text === 'Unpaid' && <span className="badges bg-lightred">{text}</span>}
          {text === 'Partial' && <span className="badges bg-lightyellow">{text}</span>}
        </div>
      ),

...
import StockadjustmentModal from '../../core/modals/stocks/stock-adjustment-Modal';
...
const StockAdjustment = () => {
  ...
  const columns: ColumnsType<any> = [
...

    {
      ...
      // dataIndex: "Quantity",
      render: () => (
        <Link to="#" className="view-note" data-bs-toggle="modal" data-bs-target="#view-notes">
          View Note
        </Link>
      ),
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        <Breadcrumbs maintitle="Stock Adjustment" subtitle=" Manage your stock adjustment" addButton="Add New" />
        {/* /product list */}

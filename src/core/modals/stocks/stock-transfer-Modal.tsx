                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div className="input-blocks">
                          ...
                          <Select classNamePrefix="react-select" options={optionsSelosyLogerro} />
                        </div>
                      </div>
                ...
                <form>
                  <div className="row">
                    <div className="col-lg-4 col-sm-6 col-12">
                      <div className="input-blocks">
                        <label>From</label>
                        <Select classNamePrefix="react-select" options={optionsStore1Store2} />
                      </div>
                    </div>
                    <div className="col-lg-4 col-sm-6 col-12">
                      <div className="input-blocks">
                    ...
                    <div className="col-lg-4 col-sm-6 col-12">
                      <div className="input-blocks">
                        <label>Satus</label>
                        <Select classNamePrefix="react-select" options={optionsSentPending} />
                      </div>
                    </div>

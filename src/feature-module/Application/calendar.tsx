...
const Calendar = () => {
  ...
  const [, setiseditdelete] = useState(false);
  // const [, setAddNewEventObj] = useState(null);
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer justify-content-center">
              ...
              <button type="button" className="btn btn-danger delete-event submit-btn" data-dismiss="modal">
                Delete
              </button>
            </div>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form>
                ...
                <div className="submit-section">
                  <button type="button" className="btn btn-primary save-category submit-btn" data-dismiss="modal">
                    Save
                  </button>
                </div>
              </form>

        ...
        <div className="content">
          ...
          <div className="row">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    alteration many variations of passages of Lorem Ipsum available there are so many ways to solve but
            ...
            <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="card-text">
                    &apos; can be escaped with &apos;&rsquo;&apos; Some quick example text to build on the card title
            ...
            <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <Link to="#" className="card-link text-secondary d-inline-block">
                    Another link
                  </Link>
                </div>
              </div>
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-12">
              ...
              <div className="row row-cols-12">
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <ImageWithBasePath src="assets/img/img-04.jpg" className="card-img mb-3" alt="..." />
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <ImageWithBasePath src="assets/img/img-05.jpg" className="card-img mb-3" alt="..." />
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <ImageWithBasePath src="assets/img/img-02.jpg" className="card-img mb-3" alt="..." />
          ...
          <div className="row">
                ...
                <div className="card-header">
                  <div className="d-flex align-items-center w-100">
                    ...
                    <div className="dropdown ms-auto">
                      <Link to="#" className="btn btn-icon btn-sm btn-light" data-bs-toggle="dropdown">
            ...
            <div className="col-xl-2">
              <div className="card">
                <div className="card-body">
                  <ImageWithBasePath src="assets/img/img-1.jpg" className="card-img mb-3" alt="..." />
            ...
            <div className="col-xl-2">
              <div className="card">
                <div className="card-body">
                  <ImageWithBasePath src="assets/img/img-2.jpg" className="card-img mb-3" alt="..." />
                  <h6 className="card-title fw-semibold mb-3">
                    Hills
            ...
            <div className="col-xl-2">
              <div className="card">
                <div className="card-body">
                  <ImageWithBasePath src="assets/img/img-3.jpg" className="card-img mb-3" alt="..." />
                  <h6 className="card-title fw-semibold mb-3">
                    Nature
                    <span className="badge bg-light text-dark float-end fs-10">Offer</span>
                  </h6>
                  <p className="card-text">With supporting text below as a natural lead-in.</p>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-xl-6">
                  <div className="card w-75">
                    ...
                    <div className="card-body">
                      <div className="card-text">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Id nostrum omnis excepturi consequatur
                        molestiae
                      </div>
                    </div>
                    <div className="card-footer">
          ...
          <div className="row">
            ...
            <div className="col-xl-4">
              <div className="card">
                ...
                <ImageWithBasePath src="assets/img/img-02.jpg" className="card-img-bottom" alt="..." />
              </div>
            </div>
            <div className="col-xl-4">
              <div className="card">
                ...
                <ImageWithBasePath src="assets/img/img-2.jpg" className="card-img rounded-0" alt="..." />
                <div className="card-body">
                  <p className="card-text mb-0">
                    <small>Last updated 3 mins ago</small>
                  </p>
            ...
            <div className="col-xl-4">
              <div className="card">
                ...
                <ImageWithBasePath src="assets/img/img-04.jpg" className="card-img rounded-0" alt="..." />
                <div className="card-footer">
                  <p className="card-text mb-0">
                    <small>Last updated 3 mins ago</small>
                  </p>
            ...
            <div className="col-xl-4">
              <div className="card">
                ...
                <ImageWithBasePath src="assets/img/img-1.jpg" className="card-img-bottom" alt="..." />
              </div>
            </div>
          </div>
          {/* /Image Caps */}
            ...
            <div className="col-xl-4">
              <div className="card overlay-card">
                ...
                <div className="card-img-overlay d-flex flex-column p-0">
                  <div className="card-header">
                    <div className="card-title text-fixed-white">Image Overlays Are Awesome!</div>
                  </div>
            ...
            <div className="col-xl-4">
              <div className="card overlay-card">
                ...
                <div className="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                  <div className="card-body text-fixed-white">
                    <div className="card-text text-fixed-white">Image Overlays Are Awesome!</div>
                    <div className="card-text mb-2">
                      There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                      alteration in some form, by injected humour, or randomised words which don&apos;t look even.
                    </div>
                  ...
                  <div className="col-md-8">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text mb-3">
                        This is a wider card with suppo rting text below as a natural lead-in to additional content.
          ...
          <div className="row">
            ...
            <div className="col-xl-3">
              <div className="card border border-info">
                <div className="card-body">
                  <p className="fs-14 fw-semibold mb-2 lh-1">New Project Discussion</p>
                  <div className="d-flex flex-wrap gap-2 mb-4">
                    <span className="badge bg-info-transparent">React</span>
            ...
            <div className="col-xl-3">
              <div className="card border border-danger">
                <div className="card-body">
                  <p className="fs-14 fw-semibold mb-2 lh-1">Recent Projects Testing</p>
                  <div className="d-flex flex-wrap gap-2 mb-4">
            ...
            <div className="col-xl-3">
              <div className="card border border-success">
                <div className="card-body">
                  <p className="fs-14 fw-semibold mb-2 lh-1">About Us Page redesign</p>
                  <div className="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <div className="row g-0">
                      <div className="col-md-8">
                        <div className="card-body">
                          ...
                          <p className="card-text mb-0">
                            This is a wild animal with supporting tactics and are very efficient at kill,they are very
                            Dangerous.
                          </p>
                          <p className="mb-0 card-text">
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div className="col">
                  <div className="card">
                    <ImageWithBasePath src="assets/img/img-04.jpg" className="card-img-top" alt="..." />
                    <div className="card-body">

                  ...
                  <div className="row row-cols-12 d-flex align-items-center">
                    <div className="p-3 col">
                      <div className="m-2 bg-outline-primary mx-auto color-container">
                        ...
                        <FeatherIcon icon="smile" className="fs-18" />
                      </div>
                      <p className="pb-0 mb-0 fw-semibold text-center">
            ...
            <div className="col-lg-12 col-sm-6">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="row row-cols-12 d-flex align-items-center">
                    <div className="p-3 col">
                      <div className="m-2 bg-primary bg-opacity-100 text-fixed-white mx-auto color-container">100%</div>
                      <p className="pb-0 mb-0 fw-semibold text-center">
                        <code>.bg-opacity-100</code>
                      </p>
                    </div>
                    <div className="p-3 col">
                      <div className="m-2 bg-primary text-fixed-white bg-opacity-75 mx-auto color-container">75%</div>
                      <p className="pb-0 mb-0 fw-semibold text-center">
                        <code>.bg-opacity-75</code>
                      </p>
                    </div>
                    <div className="p-3 col">
                      <div className="m-2 bg-primary text-fixed-black bg-opacity-50 mx-auto color-container">50%</div>
                      <p className="pb-0 mb-0 fw-semibold text-center">
                        <code>.bg-opacity-50</code>
                      </p>
                    </div>
                    <div className="p-3 col">
                      <div className="m-2 bg-primary text-fixed-black bg-opacity-25 mx-auto color-container">25%</div>
                      <p className="pb-0 mb-0 fw-semibold text-center">
                        <code>.bg-opacity-25</code>
                      </p>
                    </div>
                    <div className="p-3 col">
                      <div className="m-2 bg-primary text-fixed-black bg-opacity-10 mx-auto color-container">10%</div>
                      <p className="pb-0 mb-0 fw-semibold text-center">

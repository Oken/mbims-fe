...
const ExpenseCategory = () => {
  ...
  const data: DataEntry[] = expensecategory;
      ...
      render: () => (
        <div className="action-table-data">
          <div className="edit-delete-action">
            ...
            <Link className="me-0 confirm-text p-2 mb-0" onClick={showConfirmationAlert} to="#">
                  ...
                  <div className="modal-body custom-modal-body">
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="mb-3">
                          <label className="form-label">Expense Name</label>
                          <input type="text" defaultValue="Employee Benefits" className="form-control" />
                        </div>
                      </div>
                      {/* Editor */}
                      <div className="col-md-12">
                    ...
                    <div className="modal-footer-btn">
                      ...
                      <Link to={route.expensecategory} className="btn btn-submit">
                        Save Changes
                      </Link>
                    </div>
                  </div>

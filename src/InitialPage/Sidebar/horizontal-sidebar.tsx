      ...
      <div id="sidebar-menu-3" className="sidebar-menu">
        <ul className="nav">
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick} className={isActive ? 'subdrop' : ''}>
              <Grid />
              <span> Main Menu</span> <span className="menu-arrow" />
            </Link>
            <ul style={{ display: isActive ? 'block' : 'none' }}>
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick} className={subActive ? 'subdrop' : ''}>
          ...
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick2} className={isActive2 ? 'subdrop' : ''}>
          ...
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick3} className={isActive3 ? 'subdrop' : ''}>
            ...
            <ul style={{ display: isActive3 ? 'block' : 'none' }}>
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick2} className={subActive2 ? 'subdrop' : ''}>
                  <span>Sales</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick3} className={subActive3 ? 'subdrop' : ''}>
                  <span>Purchase</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick4} className={subActive4 ? 'subdrop' : ''}>
                  <span>Expenses</span>
                  <span className="menu-arrow" />
                </Link>
          ...
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick4} className={isActive4 ? 'subdrop' : ''}>
              <img src="assets/img/icons/users1.svg" alt="img" />
              <span>User Management</span> <span className="menu-arrow" />
            </Link>
            <ul style={{ display: isActive4 ? 'block' : 'none' }}>
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick5} className={subActive5 ? 'subdrop' : ''}>
                  <span>People</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick6} className={subActive6 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick7} className={subActive7 ? 'subdrop' : ''}>
                  <span>Base UI</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick8} className={subActive8 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick9} className={subActive9 ? 'subdrop' : ''}>
                  <span>Charts</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick10} className={subActive10 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick11} className={subActive11 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick12} className={subActive12 ? 'subdrop' : ''}>
                  <span> Forms</span>
                  <span className="menu-arrow" />
                </Link>
                <ul style={{ display: subActive12 ? 'block' : 'none' }}>
                  <li className="subMenu subMenu-two">
                    ...
                    <ul>
                      ...
                      <li>
                        <Link to="form-checkbox-radios">Checkbox &amp; Radios</Link>
                      </li>
                      <li>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick13} className={subActive13 ? 'subdrop' : ''}>
                  <span>Tables</span>
                  <span className="menu-arrow" />
                </Link>
          ...
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick5} className={isActive5 ? 'subdrop' : ''}>
              <User />
            ...
            <ul style={{ display: isActive5 ? 'block' : 'none' }}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick14} className={subActive14 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick15} className={subActive15 ? 'subdrop' : ''}>
                  <span>Pages</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick16} className={subActive16 ? 'subdrop' : ''}>
                  <span>Places</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick17} className={subActive17 ? 'subdrop' : ''}>
                  <span>Employees</span>
                  <span className="menu-arrow" />
                </Link>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick18} className={subActive18 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick19} className={subActive19 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="payroll-list" onClick={handleSubClick20} className={subActive20 ? 'subdrop' : ''}>
                  <span>Payroll</span>
                  <span className="menu-arrow" />
                </Link>
          ...
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick6} className={isActive6 ? 'subdrop' : ''}>
          ...
          <li className="subMenu">
            <Link to="#" onClick={handleSelectClick7} className={isActive7 ? 'subdrop' : ''}>
            ...
            <ul style={{ display: isActive7 ? 'block' : 'none' }}>
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick21} className={subActive21 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick22} className={subActive22 ? 'subdrop' : ''}>
                ...
                <ul style={{ display: subActive22 ? 'block' : 'none' }}>
                  ...
                  <li>
                    <Link to="social-authentication">Social Authentication</Link>
                  </li>
                  <li>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick23} className={subActive23 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick24} className={subActive24 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick25} className={subActive25 ? 'subdrop' : ''}>
              ...
              <li className="subMenu">
                <Link to="#" onClick={handleSubClick26} className={subActive26 ? 'subdrop' : ''}>

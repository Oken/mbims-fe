                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div className="mb-3">
                          ...
                          <Select classNamePrefix="react-select" options={price} placeholder="Choose Type" />
                        </div>
                      </div>
                      <div className="col-lg-6">
                        <div className="mb-3">
                      ...
                      <div className="input-blocks">
                        <div className="status-toggle modal-status d-flex justify-content-between align-items-center mb-2">
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <label htmlFor="user4" className="checktoggle mb-0 me-1" />
                            <span className="customer-toggle">Once Per Customer</span>
                          </div>
                        </div>
                        <Select classNamePrefix="react-select" options={list} placeholder="Choose" />
                      </div>

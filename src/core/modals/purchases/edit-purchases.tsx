                    ...
                    <div className="row">
                        ...
                        <div className="input-blocks add-product">
                          ...
                          <div className="row">
                            <div className="col-lg-10 col-sm-10 col-10">
                              <Select options={customers} classNamePrefix="react-select" placeholder="Choose" />
                            </div>
                            <div className="col-lg-2 col-sm-2 col-2 ps-0">
                              <div className="add-icon tab">
                                <Link to="#">
                                  {/* <PlusCircle className="feather-plus-circles" /> */}
                                  <FeatherIcon icon="plus-circle" className="feather-plus-circle" />
                                </Link>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="input-blocks">
                          ...
                          <Select options={productlist} classNamePrefix="react-select" placeholder="Choose" />
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="input-blocks">

...
import BankSettingList from '../../../core/modals/settings/bank-setting-list';
import EditBankSettingList from '../../../core/modals/settings/edit-bank-setting-list';
              ...
              <div className="settings-wrapper d-flex">
                ...
                <div className="settings-page-wrap w-50">
                  ...
                  <div className="page-header bank-settings justify-content-end">
                    <Link to={route.banksettingslist} className="btn-list me-2 active">
                      {/* <List className="feather-user" /> */}
                      <FeatherIcon icon="list" className="feather-user" />
                    </Link>
                        ...
                        <div className="card-body">
                          <div className="table-top">
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                >
                                  ...
                                  <span onClick={toggleFilterVisibility}>
                                    <FeatherIcon icon="filter" className="feather-icon" />
                                  </span>
                                  <span onClick={toggleFilterVisibility}>
                            ...
                            <div className="form-sort">
                              ...
                              <FeatherIcon icon="slider" className="info-img" />
                              <Select

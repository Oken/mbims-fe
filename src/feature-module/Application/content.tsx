      ...
      <div className="section-bulk-wrap">
        <div className="bulk-action-type">
          <div className="form-sort select-bluk">
            <Select classNamePrefix="react-select" options={optionsBulk} placeholder="Choose" />
          </div>
                        ...
                        <div className="todo-widget">
                          <div className="todo-wrapper-list">
                            ...
                            <div className=" todo-profile d-flex align-items-center">
                              <img src="./assets/img/users/user-24.jpg" alt="Img" className="img-fluid" />
                      ...
                      <div className="accordion-body">
                        <div className="todo-widget">
                          <div className="todo-wrapper-list">
                            ...
                            <div className=" todo-profile d-flex align-items-center">
                              <Link to="#" className="todo-star star-todo-inbox">
                                <span>
                                  <i data-feather="star" className="feather-star me-3" />
                                </span>
                              </Link>
                              <img src="./assets/img/avatar/avatar-2.jpg" alt="Img" className="img-fluid" />
                              <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <i className="fas fa-ellipsis-v" />
                              </Link>
                              <div className="dropdown-menu notes-menu dropdown-menu-end">
                          ...
                          <div className="todo-wrapper-list">
                            ...
                            <div className=" todo-profile d-flex align-items-center">
                              <img src="./assets/img/users/user-11.jpg" alt="Img" className="img-fluid" />
                              <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <i className="fas fa-ellipsis-v" />
                              </Link>
                              <div className="dropdown-menu notes-menu dropdown-menu-end">
                          ...
                          <div className="todo-wrapper-list">
                            ...
                            <div className=" todo-profile d-flex align-items-center">
                              <img src="./assets/img/users/user-02.jpg" alt="Img" className="img-fluid" />
                              <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <i className="fas fa-ellipsis-v" />
                              </Link>
                              <div className="dropdown-menu notes-menu dropdown-menu-end">
                      ...
                      <div className="accordion-body">
                        <div className="todo-widget">
                          <div className="todo-wrapper-list">
                            ...
                            <div className=" todo-profile d-flex align-items-center">
                              <img src="./assets/img/users/user-25.jpg" alt="Img" className="img-fluid" />
                              <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <i className="fas fa-ellipsis-v" />
                              </Link>
                              <div className="dropdown-menu notes-menu dropdown-menu-end">
                          ...
                          <div className="todo-wrapper-list">
                            ...
                            <div className=" todo-profile d-flex align-items-center">
                              <img src="./assets/img/users/user-04.jpg" alt="Img" className="img-fluid" />
                              <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <i className="fas fa-ellipsis-v" />
                              </Link>
                              <div className="dropdown-menu notes-menu dropdown-menu-end">
            ...
            <div className="row">
              <div className="todo-widget">
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    <img src="./assets/img/users/user-03.jpg" alt="Img" className="img-fluid" />
                    <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                      <i className="fas fa-ellipsis-v" />
                    </Link>
                    <div className="dropdown-menu notes-menu dropdown-menu-end">
                ...
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    <img src="./assets/img/users/user-05.jpg" alt="Img" className="img-fluid me-0" />
              ...
              <div className="todo-widget">
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    ...
                    <img src="./assets/img/users/user-05.jpg" alt="Img" className="img-fluid" />
                    <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                      <i className="fas fa-ellipsis-v" />
                    </Link>
                    <div className="dropdown-menu notes-menu dropdown-menu-end">
                ...
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    <img src="./assets/img/users/user-06.jpg" alt="Img" className="img-fluid" />
                    <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                      <i className="fas fa-ellipsis-v" />
                    </Link>
                    <div className="dropdown-menu notes-menu dropdown-menu-end">
                ...
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    <img src="./assets/img/users/user-07.jpg" alt="Img" className="img-fluid" />
                    <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                      <i className="fas fa-ellipsis-v" />
                    </Link>
                    <div className="dropdown-menu notes-menu dropdown-menu-end">
            ...
            <div className="row">
              <div className="todo-widget">
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    <img src="./assets/img/users/user-08.jpg" alt="Img" className="img-fluid" />
                    <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                      <i className="fas fa-ellipsis-v" />
                    </Link>
                    <div className="dropdown-menu notes-menu dropdown-menu-end">
                ...
                <div className="todo-wrapper-list">
                  ...
                  <div className=" todo-profile d-flex align-items-center">
                    <img src="./assets/img/users/user-09.jpg" alt="Img" className="img-fluid" />
                    <Link to="#" data-bs-toggle="dropdown" aria-expanded="false">
                      <i className="fas fa-ellipsis-v" />
                    </Link>
                    <div className="dropdown-menu notes-menu dropdown-menu-end">

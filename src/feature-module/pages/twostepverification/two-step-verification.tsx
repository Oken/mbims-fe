                ...
                <div className="wallet-add">
                  <div className="otp-box">
                    <div className="forms-block text-center">
                      <input type="text" id="digit-1" maxLength={1} defaultValue="" />
                      <input type="text" id="digit-2" maxLength={1} defaultValue="" />
                      <input type="text" id="digit-3" maxLength={1} defaultValue="" />
                      <input type="text" id="digit-4" maxLength={1} defaultValue="" />
                    </div>
                  </div>
                </div>

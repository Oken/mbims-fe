  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        <Breadcrumbs maintitle="Inventory Report" subtitle="Manage Your Inventory Report" />
        {/* /product list */}
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3">
                    <div className="input-blocks">
                      ...
                      <Select className="img-select" classNamePrefix="react-select" options={categoryOptions} />
                    </div>
                  </div>

...
import AddVariant from '../../core/modals/inventory/add-variant';
import EditVarient from '../../core/modals/inventory/edit-varient';
...
const VariantAttributes = () => {
  const dataSource = variantattributesdata;

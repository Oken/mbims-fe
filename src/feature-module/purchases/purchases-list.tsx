...
import ImportPurchases from '../../core/modals/purchases/import-purchases';
import EditPurchases from '../../core/modals/purchases/edit-purchases';
import withReactContent from 'sweetalert2-react-content';
import Swal from 'sweetalert2';
import Table from '../../core/pagination/data-table';
import { purchaseslist } from '../../core/json/purchaselistdata';
import AddPurchases from '../../core/modals/purchases/add-purchases';
...
const PurchasesList = () => {
  ...
  const filteredData: DataEntry[] = purchasedata.filter((entry) => {
  ...
  const columns: ColumnsType<any> = [
...

    {
      ...
      dataIndex: 'status',
      render: (text) => (
        <span className={`badges ${text === 'Received' ? 'status-badge' : 'badge-bgdanger'}`}>{text}</span>
      ),
    ...
    },
    {
      ...
      dataIndex: 'createdBy',
      render: (text) => (
        <span className={`badges ${text === 'Paid' ? 'badge-linesuccess' : 'badge-linedangered'}`}>{text}</span>
      ),
      ...
      render: () => (
        <div className="action-table-data">
          <div className="edit-delete-action">
            ...
            <Link to="" className="me-2 p-2" data-bs-toggle="modal" data-bs-target="#edit-units">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <FeatherIcon icon="file" className="info-img" />
                        <Select
                          className="img-select"

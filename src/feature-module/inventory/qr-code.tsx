...
import QRcodeModelPopup from '../../core/modals/inventory/qr-code';
                ...
                <div className="col-lg-6 col-12">
                  <div className="row seacrh-barcode-item">
                    <div className="col-sm-6 seacrh-barcode-item-one">
                      ...
                      <Select options={warehouse} classNamePrefix="react-select" placeholder="Manufacture" />
                    </div>
                    <div className="col-sm-6 seacrh-barcode-item-one">
                      <label className="form-label">Select Store</label>
                      <Select options={store} classNamePrefix="react-select" placeholder="Choose" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6">
                  <form>
                    ...
                    <Select options={paper} classNamePrefix="react-select" placeholder="Choose" />
                  </form>
                </div>

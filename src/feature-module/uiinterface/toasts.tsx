                ...
                <div className="card-body">
                  ...
                  >
                    <div className="d-flex">
                      <div className="toast-body">Hello, world! This is the Primary toast message.</div>
                      <button
                        type="button"
                  ...
                  >
                    <div className="d-flex">
                      <div className="toast-body">Hello, world! This is the Secondary toast.</div>
                      <button
                        type="button"
                        className="btn-close btn-close-white me-2 m-auto"
                        data-bs-dismiss="toast"
                  ...
                  >
                    <div className="d-flex">
                      <div className="toast-body">Hello, world! This is the Success toast message.</div>
                      <button
                        type="button"
                        className="btn-close btn-close-white me-2 m-auto"
                        data-bs-dismiss="toast"
                  ...
                  >
                    <div className="d-flex">
                      <div className="toast-body">Hello, world! This is the info toast message.</div>
                      <button
                        type="button"
                        className="btn-close btn-close-white me-2 m-auto"
                        data-bs-dismiss="toast"
            ...
            <div className="col-xl-4">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="toast fade show mt-2" role="alert" aria-live="assertive" aria-atomic="true">
                    <div className="toast-body">
                      Hello, world! This is a toast message.
                      <div className="mt-2 pt-2 border-top">
                        <button type="button" className="btn btn-primary btn-sm btn-wave me-2">
                          Take action
                        </button>
                        <button type="button" className="btn btn-secondary btn-sm btn-wave" data-bs-dismiss="toast">
                          Close
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="toast-container position-fixed top-0 end-0 p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handlePrimaryToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                    ...
                    >
                      <Toast.Header closeButton className="bg-secondary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSecondaryToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                    ...
                    >
                      <Toast.Header closeButton className="bg-warning text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleWarningToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-info text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleInfoToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-success text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSuccessToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-danger text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleDangerToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                ...
                <div className="card-body">
                  ...
                  <div className="toast-container position-fixed top-0 end-0 p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSolidPrimaryToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-secondary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSolidSecondaryToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-info text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSolidInfoToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-success text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSolidSuccessToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
                    ...
                    >
                      <Toast.Header closeButton className="bg-danger text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleSolidDangerToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>
                        {/* Add your toast content here */}
                        Your toast message here.
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="toast-container position-fixed top-0 start-0 p-3">
                    ...
                    >
                      <Toast.Header
                        className="toast-header bg-primary text-fixed-white"
                        //   text="text-fixed-white"
                      >
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleTopLeftToastClose} aria-label="Close" />
                      </Toast.Header>
                  ...
                  <div className="toast-container position-fixed top-0 start-50 translate-middle-x p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleTopCenterToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  ...
                  <div className="toast-container position-fixed top-0 end-0 p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleTopEndToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  <div className="toast-container position-fixed top-50 start-0 translate-middle-y p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleMiddleLeftToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  <div className="toast-container position-fixed top-50 start-50 translate-middle">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleMiddleCenterToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  <div className="toast-container position-fixed top-50 end-0 translate-middle-y p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleMiddleRightToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  <div className="toast-container position-fixed bottom-0 start-0 p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleBottomLeftToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  <div className="toast-container position-fixed bottom-0 start-50 translate-middle-x p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleBottomCenterToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
                  <div className="toast-container position-fixed bottom-0 end-0 p-3">
                    ...
                    >
                      <Toast.Header closeButton className="bg-primary text-fixed-white">
                        <strong className="me-auto">Toast</strong>
                        <Button variant="close" onClick={handleBottomRightToastClose} aria-label="Close" />
                      </Toast.Header>
                      <Toast.Body>Your, toast message here.</Toast.Body>
                    </Toast>
                  </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="bd-example bd-example-toasts d-flex p-2">
                    ...
                    >
                      <div className="toast fade show shadow-lg" role="alert" aria-live="assertive" aria-atomic="true">
                        <div className="toast-header text-default">
                          <strong className="me-auto">Toast</strong>
                          <small>11 mins ago</small>
                          <button type="button" className="btn-close" data-bs-dismiss="toast" aria-label="Close" />

...
interface EditCategoryProps {
  ...
  category: ProductCategoryT | null;
...
const EditCategoryForm = ({ closeEditCategoryModal, category, setCreatedNewCategory }: EditCategoryProps) => {
  ...
  const [editProductCategory, { isLoading, isSuccess, isError, error }] = useEditProductCategoryMutation();
  ...
  const handleFinish = async (values: any) => {
    ...
    try {
      ...
      const resCategory = await editProductCategory(category).unwrap();

...
const EditQuotation = () => {
  ...
  const handleInputChange1 = (event: { target: { value: string } }) => {
    const value = parseInt(event.target.value, 10);
    if (!isNaN(value) && value >= 1) {
      setQuantity1(value);
    }
  };
  const handleInputChange2 = (event: { target: { value: string } }) => {
    const value = parseInt(event.target.value, 10);
    if (!isNaN(value) && value >= 1) {
      setQuantity2(value);
    }
  };
  const handleInputChange3 = (event: { target: { value: string } }) => {
    const value = parseInt(event.target.value, 10);
    if (!isNaN(value) && value >= 1) {
      setQuantity3(value);
    }
                          ...
                          <div className="input-blocks">
                            ...
                            <div className="row">
                              <div className="col-lg-10 col-sm-10 col-10">
                                <Select classNamePrefix="react-select" options={customer} placeholder="Choose Brand" />
                              </div>
                        ...
                        <table className="table  datanew">
                          ...
                          <tbody>
                              ...
                              <td>
                                <div className="product-quantity">
                                  <span className="quantity-btn" onClick={handleIncrement1}>
                                    ...
                                    <FeatherIcon icon="plus-circle" className="plus-circle" />
                                  </span>
                                  <input
                                    value={quantity1}
                            ...
                            <tr>
                              ...
                              <td>
                                <div className="product-quantity">
                                  <span className="quantity-btn" onClick={handleIncrement2}>
                                    {/* <PlusCircle /> */}
                                  ...
                                  <input
                                    ...
                                    className="quntity-input"
                                  />
                                  <span className="quantity-btn" onClick={handleDecrement2}>
                                    <MinusCircle />
                                  </span>
                                </div>
                              </td>

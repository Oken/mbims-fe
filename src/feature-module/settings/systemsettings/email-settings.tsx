                        ...
                        <ul className="w-100">
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="" data-bs-toggle="modal" data-bs-target="#php-mail">
                                {/* <Tool className="me-2" /> */}
                    ...
                    <div className="col-xxl-4 col-xl-6 col-lg-12 col-md-6 d-flex">
                      <div className="connected-app-card email-setting d-flex w-100">
                        <ul className="w-100">
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="" data-bs-toggle="modal" data-bs-target="#smtp-mail">
                                {/* <Tool className="me-2" /> */}
                                <FeatherIcon icon="tool" className="me-2" />
                                Connect
                              </Link>
                    ...
                    <div className="col-xxl-4 col-xl-6 col-lg-12 col-md-6 d-flex">
                      <div className="connected-app-card email-setting d-flex w-100">
                        <ul className="w-100">
                          ...
                          <li>
                            <div className="integration-btn">
                              <Link to="" data-bs-toggle="modal" data-bs-target="#test-mail">
                                {/* <Tool className="me-2" /> */}
                                <FeatherIcon icon="tool" className="me-2" />
                                View Integration
                              </Link>

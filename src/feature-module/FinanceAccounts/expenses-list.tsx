...
const ExpensesList = () => {
  const data: DataEntry[] = expenselist;
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      dataIndex: 'status',
      render: (text) => (
        <span className={`badge ${text === 'Active' ? 'badge-linesuccess' : 'badge-linedanger'}`}>{text}</span>
      ),
      ...
      render: () => (
        <div className="action-table-data">
          <div className="edit-delete-action">
            ...
            <Link className="me-3 confirm-text p-2 mb-0" to="#" onClick={showConfirmationAlert}>
  ...
  const [, setSelectedDateTwo] = useState(null);
  const [, setSelectedDateModal] = useState(null);

  const handleDateChange = (date: Date) => {
    setSelectedDate(date as any);
  };
  const handlerefChange = (date: Date) => {
    setSelectedDateTwo(date as any);
  };
  const handleDateChangeModal = (date: Date) => {
    setSelectedDateModal(date as any);
  };
  const options = [
    ...
    <div>
      <div className="page-wrapper">
        <div className="content">
          <Breadcrumbs maintitle="Expense List" subtitle="Manage Your Expenses" addButton="Add New Expenses" />
          {/* /product list */}
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="mb-3">
                        ...
                        <Select classNamePrefix="react-select" options={optionsModalOne} placeholder="Choose" />
                      </div>
                    </div>
                    <div className="col-lg-6">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div className="input-blocks date-group">
                          <Calendar className="info-img" />
                          <div className="input-groupicon">
                            <input type="text" className="datetimepicker ps-5" placeholder="19 Jan 2023" />
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-6">
                        <div className="mb-3">
                          <label className="form-label">Amount</label>
                          <input type="text" className="form-control" defaultValue="$550.00" />
                        </div>
                      </div>
                      <div className="col-lg-6">
                        <div className="mb-3">
                          <label className="form-label">Reference</label>
                          <input type="text" className="form-control" defaultValue={55544} />
                        </div>
                      </div>
                      <div className="col-lg-12">
                      ...
                      <div className="col-md-12">
                        <div className="edit-add card">
                          ...
                          <div className="card-body-list input-blocks mb-0">
                            <textarea className="form-control" defaultValue={'Employee Vehicle'} />
                          </div>
                          <p>Maximum 600 Characters</p>
                        </div>
                      </div>

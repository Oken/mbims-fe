                      ...
                      <div className="modal-body">
                        <div className="container-fluid">
                          <div className="row">
                            ...
                            <div className="col-md-4 ms-auto bg-light border">.col-md-4 .ms-auto</div>
                          </div>
                          <div className="row mt-3">
                            <div className="col-md-3 ms-auto bg-light border">.col-md-3 .ms-auto</div>
                            <div className="col-md-2 ms-auto bg-light border">.col-md-2 .ms-auto</div>
                          </div>
                          <div className="row mt-3">
                            <div className="col-md-6 ms-auto bg-light border">.col-md-6 .ms-auto</div>
                          </div>
                          <div className="row mt-3">
                            <div className="col-sm-9 bg-light border">
                              Level 1: .col-sm-9
                              <div className="row">
                                <div className="col-8 col-sm-6 bg-light border">Level 2: .col-8 .col-sm-6</div>
                                <div className="col-4 col-sm-6 bg-light border">Level 2: .col-4 .col-sm-6</div>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div className="col-xl-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                {/* /Modal */}
                <Link className="btn btn-primary" data-bs-toggle="modal" to="#exampleModalToggle" role="button">
                  Open first modal
                </Link>
              </div>
            </div>
                      ...
                      <div className="modal-body">
                        <div className="text-center mt-2 mb-4">
                          <div className="auth-logo">
                            <Link to={route.dashboard} className="logo logo-dark">
                              <span className="logo-lg">
                                <ImageWithBasePath src="assets/img/logo.png" alt="Logo" height={42} />
                              </span>
                            </Link>
                          </div>
                        </div>
                ...
                >
                  <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="mb-3">
                              ...
                              <input type="text" className="form-control" id="field-1" placeholder="John" />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="mb-3">
                      ...
                      <div className="modal-footer">
                        <button type="button" className="btn btn-cancel waves-effect" data-bs-dismiss="modal">
                          Close
                        </button>
                ...
                >
                  ...
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <p>
                          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero ipsum quasi, error quibusdam
                          debitis maiores hic eum? Vitae nisi ipsa maiores fugiat deleniti quis reiciendis veritatis.
                        </p>
                      </div>
                      <div className="modal-footer">
                        <button type="button" className="btn btn-cancel" data-bs-dismiss="modal">
                ...
                >
                  ...
                  <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <p>
                          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea voluptatibus, ipsam quo est rerum
                          modi quos expedita facere, ex tempore fuga similique ipsa blanditiis et accusamus temporibus
                          commodi voluptas! Nobis veniam illo architecto expedita quam ratione quaerat omnis. In,
                          recusandae eos! Pariatur, deleniti quis ad nemo ipsam officia temporibus, doloribus fuga
                          asperiores ratione distinctio velit alias hic modi praesentium aperiam officiis eaque,
                          accusamus aut. Accusantium assumenda, commodi nulla provident asperiores fugit inventore iste
                          amet aut placeat consequatur reprehenderit. Ratione tenetur eligendi, quis aperiam dolores
                          magni iusto distinctio voluptatibus minus a unde at! Consequatur voluptatum in eaque
                          obcaecati, impedit accusantium ea soluta, excepturi, quasi quia commodi blanditiis? Qui
                          blanditiis iusto corrupti necessitatibus dolorem fugiat consequuntur quod quo veniam? Labore
                          dignissimos reiciendis accusamus recusandae est consequuntur iure.
                        </p>
              ...
              <div className="card-body">
                ...
                >
                  <div className="modal-dialog modal-fullscreen-md-down">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h4 className="modal-title" id="exampleModalFullscreenMdLabel">
                          Full screen below md
                        </h4>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                      </div>
                ...
                >
                  <div className="modal-dialog modal-fullscreen-xl-down">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h4 className="modal-title" id="exampleModalFullscreenXlLabel">
                          Full screen below xl
                        </h4>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                      </div>
                ...
                >
                  <div className="modal-dialog modal-fullscreen-xxl-down">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h4 className="modal-title" id="exampleModalFullscreenXxlLabel">
                          Full screen below xxl
                        </h4>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                      </div>
                    ...
                    <div className="modal-content modal-filled bg-success">
                      <div className="modal-body p-4">
                        <div className="text-center">
                          ...
                          <button type="button" className="btn btn-cancel my-2" data-bs-dismiss="modal">
                            Continue
                          </button>
                        </div>
                      </div>

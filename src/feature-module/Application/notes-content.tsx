      ...
      <div className="section-bulk-wrap">
        <div className="bulk-action-type">
          <div className="form-sort select-bluk ">
            <Select classNamePrefix="react-select" options={optionsBulk} defaultValue={optionsBulk[0]} />
          </div>
                  ...
                  <div className="notes-card me-3 marginspace">
                    <div className="notes-card-body">
                      ...
                      <div className="dropdown-menu notes-menu dropdown-menu-end">
                        <Link to="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-note-units">
                          <span>
                            <i data-feather="edit" />
                          </span>
                          Edit
                        ...
                        <Link to="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#view-note-units">
                          <span>
                            <i data-feather="eye" />
                          </span>
                          View
                    ...
                    <div className="notes-slider-widget">
                      <div className="notes-logo">
                        <Link to="#">
                          <span>
                            <img src="./assets/img/profiles/profile-01.png" alt="Profile" className="img-fluid" />
                          </span>
                        </Link>
                  ...
                  <div className="notes-card medium  me-3 marginspace">
                    ...
                    <div className="notes-slider-widget">
                      <div className="notes-logo">
                        <Link to="#">
                          <span>
                            <img src="./assets/img/profiles/profile-02.png" alt="Profile" className="img-fluid" />
                          </span>
                        </Link>
                        <div className="d-flex">
                  ...
                  <div className="notes-card high  me-3 marginspace">
                    ...
                    <div className="notes-slider-widget">
                      <div className="notes-logo">
                        <Link to="#">
                          <span>
                            <img src="./assets/img/profiles/profile-03.png" alt="Profile" className="img-fluid" />
                          </span>
                        </Link>
                        <div className="d-flex">
                ...
                <div className="notes-card notes-card-details w-100">
                  <div className="notes-card-body">
                    ...
                    <div className="dropdown-menu notes-menu dropdown-menu-end">
                      ...
                      <Link to="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete-note-units">
                        <span>
                          <i data-feather="trash-2" />
                        </span>
                        Delete
                  ...
                  <div className="notes-wrap-content">
                    ...
                    <p className="wrap-cal">
                      <i data-feather="calendar" className="feather-calendar" /> 25 Jul 2023
                    </p>
                  ...
                  <div className="notes-slider-widget notes-widget-profile">
                    <div className="notes-logo">
                      <Link to="#">
                        <span>
                          <img src="./assets/img/users/user-26.jpg" alt="Profile" className="img-fluid" />
                        </span>
                      </Link>
                      <div className="d-flex">
                        <span className="medium-square">
              ...
              <div className="col-md-4 d-flex">
                <div className="notes-card notes-card-details w-100">
                  ...
                  <div className="notes-wrap-content">
                    ...
                    <p className="wrap-cal">
                      <i data-feather="calendar" className="feather-calendar" /> 27 Jul 2023
                    </p>
                  ...
                  <div className="notes-slider-widget notes-widget-profile">
                    <div className="notes-logo">
                      <Link to="#">
                        <span>
                          <img src="./assets/img/users/user-27.jpg" alt="Profile" className="img-fluid" />
                        </span>
                      </Link>
                      <div className="d-flex">
                        <span className="high-square">
              ...
              <div className="col-md-4 d-flex">
                <div className="notes-card notes-card-details w-100">
                  ...
                  <div className="notes-wrap-content">
                    ...
                    <p className="wrap-cal">
                      <i data-feather="calendar" className="feather-calendar" /> 13 Aug 2023
                    </p>
                  ...
                  <div className="notes-slider-widget notes-widget-profile">
                    <div className="notes-logo">
                      <Link to="#">
                        <span>
                          <img src="./assets/img/users/user-28.jpg" alt="Profile" className="img-fluid" />
                        </span>
                      </Link>
                      <div className="d-flex">
                        <span className="low-square">
              ...
              <div className="col-md-4 d-flex">
                <div className="notes-card notes-card-details w-100">
                  ...
                  <div className="notes-wrap-content">
                    ...
                    <p className="wrap-cal">
                      <i data-feather="calendar" className="feather-calendar" /> 23 Aug 2023
                    </p>
                  ...
                  <div className="notes-slider-widget notes-widget-profile">
                    <div className="notes-logo">
                      <Link to="#">
                        <span>
                          <img src="./assets/img/users/user-29.jpg" alt="Profile" className="img-fluid" />
                        </span>
                      </Link>
                      <div className="d-flex">
                        <span className="high-square">
              ...
              <div className="col-md-4 d-flex">
                <div className="notes-card notes-card-details w-100">
                  ...
                  <div className="notes-wrap-content">
                    ...
                    <p className="wrap-cal">
                      <i data-feather="calendar" className="feather-calendar" /> 04 Sep 2023
                    </p>
                  ...
                  <div className="notes-slider-widget notes-widget-profile">
                    <div className="notes-logo">
                      <Link to="#">
                        <span>
                          <img src="./assets/img/users/user-30.jpg" alt="Profile" className="img-fluid" />
                        </span>
                      </Link>
                      <div className="d-flex">
                        <span className="low-square">
              ...
              <div className="col-md-4 d-flex">
                <div className="notes-card notes-card-details w-100">
                  ...
                  <div className="notes-wrap-content">
                    ...
                    <p className="wrap-cal">
                      <i data-feather="calendar" className="feather-calendar" /> 17 Sep 2023
                    </p>
                  ...
                  <div className="notes-slider-widget notes-widget-profile">
                    <div className="notes-logo">
                      <Link to="#">
                        <span>
                          <img src="./assets/img/users/user-31.jpg" alt="Profile" className="img-fluid" />
                        </span>
                      </Link>
                      <div className="d-flex">
                        <span className="medium-square">

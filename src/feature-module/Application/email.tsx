        ...
        <div className="row">
          <div className="col-lg-3 col-md-12">
            ...
            <ul className="inbox-menu">
              <li className="active">
                <Link to="#">
                  <i className="fas fa-download" /> Inbox <span className="mail-count">(5)</span>
                </Link>
              </li>
              <li>
                <Link to="#">
              ...
              <li>
                <Link to="#">
                  <i className="far fa-file-alt" /> Drafts <span className="mail-count">(13)</span>
                </Link>
              </li>
              <li>
                <Link to="#">
                  ...
                  <div className="row">
                    <div className="col-lg-9 top-action-left col-sm-12">
                      <div className="float-left">
                        ...
                        <div className="btn-group dropdown-action me-1">
                          <button type="button" className="btn btn-white dropdown-toggle" data-bs-toggle="dropdown">
                            <i className="fas fa-folder" /> <i className="fas fa-angle-down" />
                          </button>
                        ...
                        <div className="btn-group dropdown-action me-1">
                          <button type="button" data-bs-toggle="dropdown" className="btn btn-white dropdown-toggle">
                            <i className="fas fa-tags" /> <i className="fas fa-angle-down" />
                          </button>
                          <div role="menu" className="dropdown-menu">
                            <Link className="dropdown-item" to="#">
                              Work

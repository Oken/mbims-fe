...
import AddDepartmentList from '../../core/modals/hrm/add-department-list';
import EditDepartmentList from '../../core/modals/hrm/edit-department-list';
...
const DepartmentList = () => {
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      dataIndex: 'status',
      render: (text) => (
        <span className={`badge ${text === 'Active' ? 'badge-linesuccess' : 'badge-inactive'}`}>{text}</span>
      ),
        ...
        <div className="content">
          <div className="page-header">
            ...
            <ul className="table-top-head">
              ...
              <li>
                <OverlayTrigger placement="top" overlay={renderCollapseTooltip}>
                  <Link to="" data-bs-toggle="tooltip" data-bs-placement="top" id="collapse-header">
                    <ChevronUp />
            ...
            <div className="page-btn">
              <a href="" className="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-department">
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <FeatherIcon icon="file-text" className="imfo-img" />
                        <Select
                          className="img-select"
                          classNamePrefix="react-select"
